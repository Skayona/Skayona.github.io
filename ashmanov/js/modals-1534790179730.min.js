...
function modalContentFade(e){(e=$(e+" .simplebar-scroll-content")).scroll(function(){var t=e.scrollTop(),l=e[0].scrollHeight-e.height(),o=e.find(".modal-content");t<l?o.addClass("scrolled-to-bottom"):o.removeClass("scrolled-to-bottom"),t?o.addClass("scrolled-from-top"):o.removeClass("scrolled-from-top")})}$(function(){modalContentFade("#agreement-modal");var e="#callback-modal",t=$("#success-modal"),l=$("#form-callback");modalContentFade(e),$("#time-start-styler").styler(),$("#time-end-styler").styler();var o=$("#phone-callback");new Inputmask("+7 (999) 999-99-99").mask(o),l.submit(function(l){l.preventDefault(),t.modal(),$(e).modal("hide")});var a="#request-modal",n=(t=$("#success-modal"),$("#form-request")),s=$("#file-request"),m=$(".jq-file__remove");modalContentFade(a),$("#theme-request-styler").styler(),s.change(function(e){e.target.files.length?(console.log($(this)),$(this).parent().find(".jq-file__name").text(e.target.files[0].name),m.fadeIn()):($(this).parent().find(".jq-file__name").text("Прикрепить файл"),m.css("display","none"))}),m.click(function(){s.val(""),s.parent().find(".jq-file__name").text("Прикрепить файл"),m.css("display","none")});o=$("#phone-request");new Inputmask("+7 (999) 999-99-99").mask(o),n.submit(function(e){e.preventDefault(),t.modal(),$(a).modal("hide")}),modalContentFade("#success-modal")});