...
$.fn.clickToggle=function(i,n){var t=[n,i];return this.on("click",function(){t[this._tog^=1].call(this)})};var sm="(min-width: 768px)",md="(min-width: 992px)",lg="(min-width: 1200px)",container={sm:744,md:990,lg:1152};
$(function(){var o=$(".js-toggle-footer"),t=$(".js-n-footer-top");function e(){o.toggleClass("active"),t.toggleClass("active")}o.clickToggle(e,e)});
$(function(){var n=function(n){var s=n,e=$("html").hasClass("bx-touch"),t={link:null,time:null},u=null,b=null;function a(n){var e=$(".b-submenu-container--is-open").find(".b-submenu"),i=$(".b-sub-submenu-container__item--is-open").find(".b-sub-submenu"),s=parseInt(e.outerHeight());i.css("height",s);var t=n.find(".b-sub-submenu__block"),u=42,b=40+$(t[0]).parent().outerWidth(),a=n.find(".b-sub-submenu").outerWidth();t.each(function(n){u+=$(this).parent().outerHeight(),s<=u&&(u=42+$(this).parent().outerHeight(),b+=$(this).parent().outerWidth())}),b=b<a?a:b,n.find(".b-sub-submenu").css("width",b)}function l(){$(".b-menu__link.b-link--is-active").removeClass("b-link--is-active"),$(".b-submenu-container--is-open").removeClass("b-submenu-container--is-open")}e?(s.find(".b-menu__link").click(function(){l();var n=$(this),e=n.attr("href"),i=n.siblings(".b-submenu-container"),s=0<i.length;if(n.hasClass("b-link--is-active")||n.addClass("b-link--is-active"),i.css("left",parseInt($(this).offset().left)-32),s&&(i.addClass("b-submenu-container--is-open"),u!=e))return u=e,!1}),s.find(".b-submenu__link").click(function(){$(".b-sub-submenu-container__item--is-open").removeClass("b-sub-submenu-container__item--is-open");var n=$(this),e=n.attr("href"),i=s.find('.b-sub-submenu-container__item[data-href="'+e+'"]');if(s.find(".b-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active"),n.hasClass("b-submenu__link--has-submenu")&&0<i.length&&(i.addClass("b-sub-submenu-container__item--is-open"),a(),b!=e))return b=e,!1}),s.find(".b-sub-submenu__link").click(function(){var n=$(this);s.find(".b-sub-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active")}),$("body, .b-city__link, .b-search__link").on("click",function(){l()})):(s.find(".b-menu__link").hover(function(){l();var n=$(this),e=n.siblings(".b-submenu-container"),i=0<e.length;n.hasClass("b-link--is-active")||n.addClass("b-link--is-active"),e.css("left",parseInt($(this).offset().left)-32),i&&(e.addClass("b-submenu-container--is-open"),t={link:$(this).attr("href"),time:(new Date).getTime()})}),s.find(".b-menu__link").on("click",function(){if((new Date).getTime()-t.time<700&&t.link==$(this).attr("href"))return!1}),s.find(".b-submenu__link").hover(function(){$(".b-sub-submenu-container__item--is-open").removeClass("b-sub-submenu-container__item--is-open");var n=$(this),e=n.attr("href"),i=s.find('.b-sub-submenu-container__item[data-href="'+e+'"]');s.find(".b-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active"),n.hasClass("b-submenu__link--has-submenu")&&0<i.length&&(i.addClass("b-sub-submenu-container__item--is-open"),a(i))}),s.find(".b-sub-submenu__link").hover(function(){var n=$(this);s.find(".b-sub-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active")}),$("body, .b-city__link, .b-search__link").on("click",function(){l()}),s.find(".b-submenu-container").hover(function(){},function(){var n=$(this),e="b-submenu-container--is-open";n.hasClass(e)&&n.removeClass(e)}))};new n($(".b-desktop-menu")),new n($(".b-connect-us"));var e=$(".b-menu2");$(".b-menu-icon").click(function(){e.hasClass("b-menu2--is-open")?($("body").addClass("mobile-menu-is-open"),$(".menu-mobile-open-overlay").fadeIn()):($("body").removeClass("mobile-menu-is-open"),$(".menu-mobile-open-overlay").fadeOut())}),$(window).on("resize",function(){window.matchMedia("(min-width: 1200px)").matches&&(e.removeClass("b-menu2--is-open"),e.fadeOut().css("left","0"),$("body").removeClass("mobile-menu-is-open"),$(".menu-mobile-open-overlay").fadeOut())})});
...
$(function(){modalContentFade("#agreement-modal")});
$(function(){var e="#callback-modal",l=$("#success-modal"),a=$("#form-callback");modalContentFade(e),$("#time-start-styler").styler(),$("#time-end-styler").styler();var t=$("#phone-callback");new Inputmask("+7 (999) 999-99-99").mask(t),a.submit(function(a){a.preventDefault(),l.modal(),$(e).modal("hide")})});
$(function(){var t="#request-modal",n=$("#success-modal"),e=$("#form-request"),a=$("#file-request"),s=$(".jq-file__remove");modalContentFade(t),$("#theme-request-styler").styler(),a.change(function(e){e.target.files.length?(console.log($(this)),$(this).parent().find(".jq-file__name").text(e.target.files[0].name),s.fadeIn()):($(this).parent().find(".jq-file__name").text("Прикрепить файл"),s.css("display","none"))}),s.click(function(){a.val(""),a.parent().find(".jq-file__name").text("Прикрепить файл"),s.css("display","none")});var i=$("#phone-request");new Inputmask("+7 (999) 999-99-99").mask(i),e.submit(function(e){e.preventDefault(),n.modal(),$(t).modal("hide")})});
$(function(){modalContentFade("#success-modal")});

$(function(){$(".js-cur-year").text((new Date).getFullYear())});


$(function(){$(".js-services-list").each(function(){var i=$(this).find(".n-service-list__item"),e=$(this).find(".js-toggle-service");function s(){e.toggleClass("hidden"),i.toggleClass("hidden")}e.clickToggle(s,s),6<i.length&&e.addClass("active")})});