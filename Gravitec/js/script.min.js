...
function showTab(t,a){t.click(function(){t.hasClass("tabs__nav-item--active")||(tabsNav.removeClass("tabs__nav-item--active"),tabsToShow.removeClass("tabs__section--active"),t.addClass("tabs__nav-item--active"),a.addClass("tabs__section--active"))})}var tabsNav=$(".js-tabs"),tabInfo=$(".js-tabs-info"),tabResult=$(".js-tabs-result"),tabTotal=$(".js-tabs-total"),tabsToShow=$(".js-tabs-to-show"),tabToShowInfo=$(".js-tabs-to-show-info"),tabToShowResult=$(".js-tabs-to-show-result"),tabToShowTotal=$(".js-tabs-to-show-total");showTab(tabInfo,tabToShowInfo),showTab(tabResult,tabToShowResult),showTab(tabTotal,tabToShowTotal),$(".js-return-to-main-tab").click(function(t){t.preventDefault(),widgetInfoBlocks.removeClass("tabs__info-block--active"),widgetInfoMain.addClass("tabs__info-block--active")});
var aPush=$(".js-a-scheme"),aImg=$(".js-a-scheme-img");$(window).on("load resize",function(){if($(window).width()>768&&$(window).width()<992){var h=0;aPush.each(function(i){h+=$(this).height()}),aImg.css("height",h)}else aImg.css("height","100%")});
var vmHeight,vmBorderSize,vm=$(".canal-flowchart__scheme"),vmBorder=$(".canal-flowchart__scheme-item");$(window).on("load resize",function(){$(window).width()>=768?(vmHeight=vm.height(),vmBorderSize=vmHeight/2,vmBorder.find("style").remove(),vmBorder.append("<style>.canal-flowchart__scheme-item::after{border-top-width: "+vmBorderSize+"px;}.canal-flowchart__scheme-item::after{border-bottom-width: "+vmBorderSize+"px;}</style>")):vmBorder.find("style").remove()});
var fbMessenger=$(".js-fb-messenger");$(window).scroll(function(){$(this).scrollTop()>100?fbMessenger.fadeIn(500):fbMessenger.fadeOut(500)});
var currentYear=$(".js-year"),footerContactBtn=$("#footer-contact-btn"),footerModal=$(".js-footer-contact-modal"),cookiesBtn=$(".js-cookies-btn"),cookieModal=$(".js-cookies-modal");currentYear.text((new Date).getFullYear());
function inputError(t){t.on("focusout",function(){var t=$(this).val(),a=new RegExp($(this).attr("pattern"));0!=t&&a.test(t)?$(this).removeClass("input-invalid"):$(this).addClass("input-invalid")})}function set_alias(){var t=$("#contact-email").val();Gravitec.push(["isSubscribed",function(a){Gravitec.push(["setAlias",t])}])}function set_alias_check(){contactForm.submit(function(t){t.preventDefault();$("#contact-name").val(),$("#contact-email").val(),$("#contact-message").val();var a=[nameInput,emailInput,messageInput,antispam,$("#contact-submit")],n=contactForm.serialize();return $.ajax({type:"POST",url:"php/contact.php",dataType:"json",data:n,success:function(t){}}),$.each(a,function(t){a[t].attr("disabled","disabled")}),formSuccess.fadeIn(500).css({display:"flex"}),setTimeout(function(){$.each(a,function(t){a[t].removeAttr("disabled").removeClass("input-invalid")}),contactForm.trigger("reset"),$("#contact-submit").blur()},5e3),setTimeout(function(){formSuccess.fadeOut(500)},5200),set_alias(),!0})}var contactForm=$("#contact-form");formSuccess=$(".js-contact-form-success"),nameInput=$("#contact-name"),emailInput=$("#contact-email"),messageInput=$("#contact-message"),antispam=$("#contact-antispam"),inputError(nameInput),inputError(emailInput),inputError(messageInput),inputError(antispam);
function muneHide(){hamburger.removeClass(hamburgerActive),menuPrimary.fadeOut(500),$("body").css("overflow","initial"),header.removeClass("header--active")}var headerHieght,header=$(".js-header"),hamburger=$(".js-hamburger"),hamburgerActive="hamburger--active",menuPrimary=$(".js-menu-primary"),menuPrimaryLink=".menu-primary__link",menuPrimaryLinkActive="menu-primary__link--active",menuSecondary=$(".menu-secondary");hamburger.click(function(){$(this).hasClass(hamburgerActive)?(muneHide(),$(window).scrollTop()>25&&header.addClass("header--on-scroll")):($(this).addClass(hamburgerActive),header.addClass("header--active").removeClass("header--on-scroll"),menuPrimary.fadeIn(500).css({display:"flex"}),$("body").css("overflow","hidden"))}),$(window).on("load resize",function(){headerHieght=header.height(),welcome.css({"padding-top":headerHieght+"px"}),$(this).scrollTop()>25?header.addClass("header--on-scroll"):header.removeClass("header--on-scroll"),window.matchMedia(lg).matches?(hamburger.removeClass(hamburgerActive),$("body").css("overflow","initial"),header.removeClass("header--active"),menuPrimary.css({display:"flex"})):hamburger.hasClass(hamburgerActive)||(menuPrimary.css({top:headerHieght+"px"}),menuPrimary.css({display:"none"}))}),$(window).scroll(function(){$(this).scrollTop()>25?header.addClass("header--on-scroll"):header.removeClass("header--on-scroll")}),menuSecondary.mousemove(function(){$(this).siblings(menuPrimaryLink).addClass(menuPrimaryLinkActive)}),menuSecondary.mouseout(function(){$(this).siblings(menuPrimaryLink).removeClass(menuPrimaryLinkActive)});var supportBtn=$("#js-support-btn");
function closeFooterModal(){nameInput.removeClass("input-invalid"),emailInput.removeClass("input-invalid"),messageInput.removeClass("input-invalid"),antispam.removeClass("input-invalid")}var modalOverlay=$(".js-modal"),modalContent=$(".js-modal-content"),modalCross=$(".js-modal-cross"),cookiesOkBtn=$(".js-cookies-ok-btn"),viberSoonBtn=$(".call-to-action--viber"),viberSoonModal=$(".js-viber-modal");modalContent.click(function(o){o.stopPropagation()}),footerContactBtn.click(function(){footerModal.fadeIn(500).css("display","flex"),$("body").css("overflow","hidden")}),supportBtn.click(function(){footerModal.fadeIn(500).css("display","flex"),$("body").css("overflow","hidden")}),cookiesBtn.click(function(){cookieModal.fadeIn(500).css("display","flex"),$("body").css("overflow","hidden")}),viberSoonBtn.click(function(o){o.preventDefault(),viberSoonModal.fadeIn(500).css("display","flex"),$("body").css("overflow","hidden")}),modalOverlay.click(function(){modalOverlay.fadeOut(500),$("body").css("overflow","initial"),closeFooterModal()}),modalCross.click(function(){modalOverlay.fadeOut(500),$("body").css("overflow","initial"),closeFooterModal()}),cookiesOkBtn.click(function(){modalOverlay.fadeOut(500),$("body").css("overflow","initial"),closeFooterModal()});

$(window).on("load",function(){$("body").css("overflow","hidden"),$(".js-preloader").delay(500).fadeOut("100"),setTimeout(function(){$("body").css("overflow","initial")},200),setTimeout(function(){serverReachable()||offlineMessage()},900)});
var welcome=$(".js-welcome");navigator.userAgent.match(/Edge/i)&&welcome.append("<style>.welcome::before{animation:none;}</style>");
function inputError(t){t.on("focusout",function(){var t=$(this).val(),e=new RegExp($(this).attr("pattern"));0!=t&&e.test(t)?$(this).removeClass("input-invalid"):$(this).addClass("input-invalid")})}function inputErrorNotRequried(t){t.on("focusout",function(){var t=$(this).val();t.length>0&&0==t?$(this).addClass("input-invalid"):$(this).removeClass("input-invalid")})}function integerInputValidation(t){var e=document.getElementById(t),i=/[0-9]/;e.addEventListener("keypress",function(t){var r=String.fromCharCode(t.charCode);0==e.selectionStart&&"0"==r?t.preventDefault():i.test(r)||t.preventDefault()}),calcForm.change(function(){var t=e.value.split("");t.length>0&&0==t[0]&&(e.value=e.value.replace("0",""))})}function fractionalInputValidation(t){var e=document.getElementById(t),i=/[0-9.,]/,r=/[0-9]/;e.addEventListener("keypress",function(t){var s=String.fromCharCode(t.charCode),a=e.selectionStart,o=0,n=e.value.split("");n.forEach(function(t){"."!=t&&","!=t||o++}),i.test(s)||t.preventDefault(),(0!=a&&1!=a||0!=n[0]||"."!=n[1]||0!=s)&&(1==a&&0==n[0]&&n.length>1||(r.test(s)&&1==a&&0==n[0]?e.value=e.value.replace("0","0."):(","==s||"."==s)&&o>0&&t.preventDefault()))}),calcForm.change(function(){var t=e.value.split(""),i=0;if(t.forEach(function(t){"."!=t&&","!=t||i++}),i>0)for(;0==t[0];)e.value=e.value.replace("0",""),t=e.value.split("");t.length>0&&!r.test(t[0])?e.value="0"+e.value:t.length>0&&0==t[0]&&r.test(t[1])&&0==i&&(e.value=e.value.replace("0","0.")),e.value=e.value.replace(",",".")})}function replaceIntegerType(t){t.attr({type:"text",pattern:"[0-9]*"})}function replaceFractionalType(t){t.attr({type:"text",pattern:"[0-9.,]*"})}function newResultTable(t,e,i,r,s,a,o,n,l){$("#total-result").append('<li class="total-results total-results--'+t+'"><div class="total-results__input"><p class="total-results__title">Адрес сайта:&nbsp;<span class="total-results__value">'+e+'</span></p><p class="total-results__title">Посещаемость:&nbsp;<span class="total-results__value">'+i+'</span></p><p class="total-results__title">http/https:&nbsp;<span class="total-results__value">'+r+'</span></p><p class="total-results__title">Прогнозы по сбору базы данных подписчиков:&nbsp;<span class="total-results__value">'+s+'</span></p><p class="total-results__title">Количество рассылок в месяц:&nbsp;<span class="total-results__value">'+a+'</span></p><p class="total-results__title">Расчетный CTR (%):&nbsp;<span class="total-results__value">'+o+'</span></p><p class="total-results__title">Конверсия в покупку %:&nbsp;<span class="total-results__value">'+n+'</span></p><p class="total-results__title">Доходность на одного покупателя сайта (у.е.):&nbsp;<span class="total-results__value">'+l+'</span></p></div><div class="total-results__table"><table class="result-table"><thead><tr><th class="result-table__title">Месяц с момента подключения</th><th class="result-table__title">Подписчиков на конец месяца</th><th class="result-table__title">Прирост дневной посещаемости, %</th><th class="result-table__title">Дополнительный заработок в месяц, $</th></tr></thead><tbody><tr class="result-table__row"><td class="result-table__value">1</td><td class="result-table__value subscriber_1">...</td><td class="result-table__value growth_1">...</td><td class="result-table__value profit_1">...</td></tr><tr class="result-table__row"><td class="result-table__value">2</td><td class="result-table__value subscriber_2">...</td><td class="result-table__value growth_2">...</td><td class="result-table__value profit_2">...</td></tr><tr class="result-table__row"><td class="result-table__value">3</td><td class="result-table__value subscriber_3">...</td><td class="result-table__value growth_3">...</td><td class="result-table__value profit_3">...</td></tr></tbody></table></div></li>')}function showPrompt(t,e){t.click(function(){function t(t){"block"==t.css("display")&&e!=t&&t.slideUp(400)}window.matchMedia(md).matches||(t(widgetPromptMobileUrl),t(widgetPromptMobileTraffic),t(widgetPromptMobileHttp),t(widgetPromptMobileHttps),t(widgetPromptMobileForecast),t(widgetPromptMobileMailing),t(widgetPromptMobileCtr),t(widgetPromptMobileConversion),t(widgetPromptMobileProfit),e.slideToggle(400))})}function showinfo(t,e){t.on("focus",function(){tabsNav.removeClass("tabs__nav-item--active"),tabsToShow.removeClass("tabs__section--active"),tabInfo.addClass("tabs__nav-item--active"),tabToShowInfo.addClass("tabs__section--active"),widgetInputs.removeClass("js-info--active"),widgetInfoBlocks.removeClass("tabs__info-block--active"),t.addClass("js-info--active"),e.addClass("tabs__info-block--active")})}var calcForm=$("#calc-form"),urlInput=$("#url"),trafficInput=$("#traffic"),mailingListsInput=$("#custom_mailing_list"),ctrInput=$("#custom_ctr"),conversion=$("#conversion"),profit=$("#profit"),resultCounter=0,tabsContent=$(".js-tabs-content");$(window).on("resize load",function(){window.matchMedia(md).matches?tabsContent.css("height",calcForm.height()-2+"px"):tabsContent.css("height","auto")});var backslash=String.fromCharCode(92),UrlPattern="^(http:"+backslash+"/"+backslash+"/www"+backslash+".|https:"+backslash+"/"+backslash+"/www"+backslash+".|http:"+backslash+"/"+backslash+"/|https:"+backslash+"/"+backslash+"/)?[a-z0-9]+(["+backslash+"-"+backslash+".]{1}[a-z0-9]+)*"+backslash+".[a-z]{2,5}(:[0-9]{1,5})?("+backslash+"/.*)?$",integerPattern="^0*[1-9]"+backslash+"d*$",fractionalPattern="^[0-9]+("+backslash+".[0-9]{1,5})$|[0-9]+(,[0-9]{1,5})|[1-9]+[0-9]{1,15}|[1-9]";urlInput.attr("pattern",UrlPattern),trafficInput.attr("pattern",integerPattern),mailingListsInput.attr("pattern",integerPattern),ctrInput.attr("pattern",fractionalPattern),conversion.attr("pattern",fractionalPattern),profit.attr("pattern",fractionalPattern),inputError(urlInput),inputError(mailingListsInput),inputError(ctrInput),inputError(trafficInput),inputErrorNotRequried(conversion),inputErrorNotRequried(profit),$("main").hasClass("calc-page")&&(integerInputValidation("traffic"),integerInputValidation("custom_mailing_list"),fractionalInputValidation("custom_ctr"),fractionalInputValidation("conversion"),fractionalInputValidation("profit")),calcForm.change(function(){switch($siteUrl=$("#url").val(),$traffic=$("#traffic").val(),$siteType=$("[name=transferProtocol]:checked").val(),$subscriberGrowth=$("#collection_forecast").val(),$subscriberGrowthVal=$("#collection_forecast").val(),$mailingLists=$("#mailing_lists").val(),$ctr=$("#ctr").val(),$conversion=$("#conversion").val(),$profit=$("#profit").val(),$unsubscribers=.25,"custom-list"==$mailingLists?(mailingListsInput.slideDown(400).fadeIn(500),mailingListsInput.attr("required",!0),$mailingLists=mailingListsInput.val()):(mailingListsInput.slideUp(400).fadeOut(500),mailingListsInput.attr("required",!1)),"custom-ctr"==$ctr?(ctrInput.slideDown(400).fadeIn(500),ctrInput.attr("required",!0),$ctr=ctrInput.val()):(ctrInput.slideUp(400).fadeOut(500),ctrInput.attr("required",!1)),$siteType){case"http":"minimum"==$subscriberGrowth?$subscriberGrowthVal="0.005":"normal"==$subscriberGrowth?$subscriberGrowthVal="0.01":"maximum"==$subscriberGrowth&&($subscriberGrowthVal="0.015");break;case"https":"minimum"==$subscriberGrowth?$subscriberGrowthVal="0.03":"normal"==$subscriberGrowth?$subscriberGrowthVal="0.05":"maximum"==$subscriberGrowth&&($subscriberGrowthVal="0.07")}window.matchMedia(md).matches?setTimeout(function(){tabsContent.animate({height:calcForm.height()-2+"px"},300)},400):tabsContent.css("height","auto")});var BrowserDetect={init:function(){this.browser=this.searchString(this.dataBrowser)||"An unknown browser",this.version=this.searchVersion(navigator.userAgent)||this.searchVersion(navigator.appVersion)||"an unknown version",this.OS=this.searchString(this.dataOS)||"an unknown OS"},searchString:function(t){for(var e=0;e<t.length;e++){var i=t[e].string,r=t[e].prop;if(this.versionSearchString=t[e].versionSearch||t[e].identity,i){if(-1!=i.indexOf(t[e].subString))return t[e].identity}else if(r)return t[e].identity}},searchVersion:function(t){var e=t.indexOf(this.versionSearchString);if(-1!=e)return parseFloat(t.substring(e+this.versionSearchString.length+1))},dataBrowser:[{string:navigator.userAgent,subString:"Chrome",identity:"Chrome"},{string:navigator.userAgent,subString:"OmniWeb",versionSearch:"OmniWeb/",identity:"OmniWeb"},{string:navigator.vendor,subString:"Apple",identity:"Safari",versionSearch:"Version"},{prop:window.opera,identity:"Opera",versionSearch:"Version"},{string:navigator.vendor,subString:"iCab",identity:"iCab"},{string:navigator.vendor,subString:"KDE",identity:"Konqueror"},{string:navigator.userAgent,subString:"Firefox",identity:"Firefox"},{string:navigator.vendor,subString:"Camino",identity:"Camino"},{string:navigator.userAgent,subString:"Netscape",identity:"Netscape"},{string:navigator.userAgent,subString:"MSIE",identity:"Internet Explorer",versionSearch:"MSIE"},{string:navigator.userAgent,subString:"Gecko",identity:"Mozilla",versionSearch:"rv"},{string:navigator.userAgent,subString:"Mozilla",identity:"Netscape",versionSearch:"Mozilla"}],dataOS:[{string:navigator.platform,subString:"Win",identity:"Windows"},{string:navigator.userAgent,subString:"Android",identity:"Android"},{string:navigator.userAgent,subString:"iPad",identity:"iPad"},{string:navigator.platform,subString:"Mac",identity:"Mac"},{string:navigator.userAgent,subString:"iPhone",identity:"iPhone/iPod"},{string:navigator.platform,subString:"Linux",identity:"Linux"}]};BrowserDetect.init(),"Android"!=BrowserDetect.OS&&(replaceIntegerType(trafficInput),replaceIntegerType(mailingListsInput),replaceFractionalType(ctrInput),replaceFractionalType(conversion),replaceFractionalType(profit)),$.getJSON("//freegeoip.net/json/?callback=?",function(t){calcForm.submit(function(e){var i=!1;if(e.preventDefault(),(conversion.hasClass("input-invalid")||profit.hasClass("input-invalid"))&&(i=!0),!i){$UM=0,newResultTable(++resultCounter,$siteUrl,$traffic,$siteType,$subscriberGrowthVal,$mailingLists,$ctr,$conversion,$profit);for(var r=1;r<7;r++)$UM=parseInt(parseInt($traffic)*parseFloat($subscriberGrowthVal)+$UM-$UM*$unsubscribers),$DG=(.45*$UM*parseFloat($ctr)*.01/(parseInt($traffic)/30)*100).toFixed(2),$DR=(.45*$UM*parseFloat($ctr)*.01*parseInt($mailingLists)*parseFloat($conversion)*.01*parseFloat($profit)).toFixed(0),r<4?($("#result-table .subscriber_"+r).text($UM),$("#result-table .growth_"+r).text($DG),$("#result-table .profit_"+r).text($DR),$(".total-results--"+resultCounter+" .subscriber_"+r).text($UM),$(".total-results--"+resultCounter+" .growth_"+r).text($DG),$(".total-results--"+resultCounter+" .profit_"+r).text($DR)):($("#result-table .subscriber_"+r).text("..."),$("#result-table .growth_"+r).text("..."),$("#result-table .profit_"+r).text("..."));$siteType.length>1&&$siteUrl.length>1&&$mailingLists.length>0&&$ctr.length>0&&$profit.length>0&&$conversion.length>0&&($(".js-tabs-result").css("visibility","visible"),$(".js-tabs-total").css("visibility","visible"),$(".js-tabs").removeClass("tabs__nav-item--active"),$(".js-tabs-to-show").removeClass("tabs__section--active"),$(".js-tabs-result").addClass("tabs__nav-item--active"),$(".js-tabs-to-show-result").addClass("tabs__section--active"));var s=new Date,a=(new Date).getTimezoneOffset()/60,o="UTC"+(a>0?"-"+a:"+"+-a),n=s.getDate()+"."+(s.getMonth()+1)+"."+s.getFullYear()+" "+s.getHours()+":"+s.getMinutes()+" "+o,l={Browser:BrowserDetect.browser,"Version of Browser":String(BrowserDetect.version),OS:BrowserDetect.OS,Date:n,url:$siteUrl,traffic:$traffic,collection_forecast:$subscriberGrowth,mailing_lists:$mailingLists,ctr:$ctr,conversion:$conversion,profit:$profit,city:t.city,country:t.country_name,ip:t.ip},c=JSON.stringify(l,"",4);return $.ajax({type:"POST",url:"php/calculator.php",data:{foo:c}}),!1}})});var widgetInputUrl=$(".js-calc-url"),widgetPromptMobileUrl=$(".js-prompt-url-mob"),widgetInputTraffic=$(".js-calc-traffic"),widgetPromptMobileTraffic=$(".js-prompt-traffic-mob"),widgetInputHttp=$(".js-calc-http"),widgetPromptMobileHttp=$(".js-prompt-http-mob"),widgetInputHttps=$(".js-calc-https"),widgetPromptMobileHttps=$(".js-prompt-https-mob"),widgetInputForecast=$(".js-calc-forecast"),widgetPromptMobileForecast=$(".js-prompt-forecast-mob"),widgetInputMailing=$(".js-calc-mailing"),widgetPromptMobileMailing=$(".js-prompt-mailing-mob"),widgetInputCtr=$(".js-calc-ctr"),widgetPromptMobileCtr=$(".js-prompt-ctr-mob"),widgetInputConversion=$(".js-calc-conversion"),widgetPromptMobileConversion=$(".js-prompt-conversion-mob"),widgetInputProfit=$(".js-calc-profit"),widgetPromptMobileProfit=$(".js-prompt-profit-mob"),widgetInputs=$(".js-info"),widgetUrl=$(".js-info-url"),widgetTraffic=$(".js-info-traffic"),widgetHttp=$(".js-info-http"),widgetHttps=$(".js-info-https"),widgetForecast=$(".js-info-forecast"),widgetMailing=$(".js-info-mailing"),widgetCtr=$(".js-info-ctr"),widgetConversion=$(".js-info-conversion"),widgetProfit=$(".js-info-profit"),widgetInfoBlocks=$(".js-info-blocks"),widgetInfoMain=$(".js-info-block-main"),widgetInfoUrl=$(".js-info-block-url"),widgetInfoTraffic=$(".js-info-block-traffic"),widgetInfoHttp=$(".js-info-block-http"),widgetInfoHttps=$(".js-info-block-https"),widgetInfoForecast=$(".js-info-block-forecast"),widgetInfoMailing=$(".js-info-block-mailing"),widgetInfoCtr=$(".js-info-block-ctr"),widgetInfoConversion=$(".js-info-block-conversion"),widgetInfoProfit=$(".js-info-block-profit");showPrompt(widgetInputUrl,widgetPromptMobileUrl),showPrompt(widgetInputTraffic,widgetPromptMobileTraffic),showPrompt(widgetInputHttp,widgetPromptMobileHttp),showPrompt(widgetInputHttps,widgetPromptMobileHttps),showPrompt(widgetInputForecast,widgetPromptMobileForecast),showPrompt(widgetInputMailing,widgetPromptMobileMailing),showPrompt(widgetInputCtr,widgetPromptMobileCtr),showPrompt(widgetInputConversion,widgetPromptMobileConversion),showPrompt(widgetInputProfit,widgetPromptMobileProfit),$(window).on("load resize",function(){window.matchMedia(md).matches&&(widgetPromptMobileUrl.slideUp(0),widgetPromptMobileTraffic.slideUp(0),widgetPromptMobileHttp.slideUp(0),widgetPromptMobileHttps.slideUp(0),widgetPromptMobileForecast.slideUp(0),widgetPromptMobileMailing.slideUp(0),widgetPromptMobileCtr.slideUp(0),widgetPromptMobileConversion.slideUp(0),widgetPromptMobileProfit.slideUp(0))}),showinfo(widgetUrl,widgetInfoUrl),showinfo(widgetTraffic,widgetInfoTraffic),showinfo(widgetHttp,widgetInfoHttp),showinfo(widgetHttps,widgetInfoHttps),showinfo(widgetForecast,widgetInfoForecast),showinfo(widgetMailing,widgetInfoMailing),showinfo(widgetCtr,widgetInfoCtr),showinfo(widgetConversion,widgetInfoConversion),showinfo(widgetProfit,widgetInfoProfit);
function inputError(e){e.on("focusout",function(){var e=$(this).val(),t=new RegExp($(this).attr("pattern"));0!=e&&t.test(e)?$(this).removeClass("input-invalid"):$(this).addClass("input-invalid")})}var resultForm=$("#result-form");resultformSuccess=$(".js-result-form-success"),resultemailInput=$("#result-form-email"),inputError(resultemailInput),$.getJSON("//freegeoip.net/json/?callback=?",function(e){resultForm.submit(function(t){t.preventDefault();var r=$("#result-form-email").val(),s=[$("#result-form-email"),$("#result-form-submit")],i=(resultForm.serialize(),new Date),o=(new Date).getTimezoneOffset()/60,u="UTC"+(o>0?"-"+o:"+"+-o),l=i.getDate()+"."+(i.getMonth()+1)+"."+i.getFullYear()+" "+i.getHours()+":"+i.getMinutes()+" "+u,n={Browser:BrowserDetect.browser,"Version of Browser":String(BrowserDetect.version),OS:BrowserDetect.OS,Date:l,url:$siteUrl,traffic:$traffic,collection_forecast:$subscriberGrowth,mailing_lists:$mailingLists,ctr:$ctr,conversion:$conversion,profit:$profit,city:e.city,country:e.country_name,ip:e.ip,email:r},a=JSON.stringify(n,"",4);return console.log(a),$.ajax({type:"POST",url:"php/calculator.php",data:{foo:a}}),$.each(s,function(e){s[e].attr("disabled","disabled")}),resultformSuccess.fadeIn(500).css({display:"flex"}),setTimeout(function(){$.each(s,function(e){s[e].removeAttr("disabled").removeClass("input-invalid")}),resultForm.trigger("reset"),$("#result-form-submit").blur()},5e3),setTimeout(function(){resultformSuccess.fadeOut(500)},5200),!1})});
var partnersSlider=$(".js-partners-logo");partnersSlider.slick({arrows:!1,autoplay:!0,autoplaySpeed:0,lazyLoad:"ondemand",cssEase:"linear",mobileFirst:!0,pauseOnHover:!1,pauseOnFocus:!1,slidesPerRow:1,swipe:!1,speed:8e3,rows:2,vertical:!0,responsive:[{breakpoint:576,settings:{slidesPerRow:2}},{breakpoint:768,settings:{slidesPerRow:3}},{breakpoint:992,settings:{autoplay:!1,rows:3,slidesPerRow:4}}]});
var clientsSlider=$(".js-clients-logo");clientsSlider.slick({arrows:!1,autoplay:!0,autoplaySpeed:0,lazyLoad:"ondemand",cssEase:"linear",mobileFirst:!0,pauseOnHover:!1,pauseOnFocus:!1,slidesPerRow:1,swipe:!1,speed:8e3,rows:2,vertical:!0,responsive:[{breakpoint:576,settings:{slidesPerRow:2}},{breakpoint:768,settings:{slidesPerRow:2}},{breakpoint:992,settings:{slidesPerRow:4}},{breakpoint:1200,settings:{slidesPerRow:5}}]});
var canalItem=$(".canal__item");navigator.userAgent.match(/firefox/i)&&(canalItem.css("box-shadow","0 0 1px 1px rgba(55,58,60,.1)"),canalItem.hover(function(){$(this).css("box-shadow","0 60px 60px rgba(55,58,60,.1), 0 -5px 60px rgba(55,58,60,.1)")},function(){$(this).css("box-shadow","0 0 1px 1px rgba(55,58,60,.1)")}));
function sendTestPush(){Notification.requestPermission(function(){sendNotification()})}function sendNotification(){countMessage>1&&(countMessage=0);var e=[{title:"Web push уведомления",body:"Эффективный канал коммуникации!",link:"https://gravitec.net/blog/zachem-vashemu-biznesu-web-push/?utm_source=pushpage&utm_medium=testbutton&utm_campaign=blog"},{title:"Gravitec.net - ваш сервис уведомлений",body:"Начните работу с Gravitec.net бесплатно!",link:"https://push.gravitec.net/register?utm_source=pushpage&utm_medium=testbutton&utm_campaign=register"}][countMessage],o=new Notification(e.title,{icon:"img/anatomy/example-push.png",body:e.body});console.log(o),o.onclick=function(){window.open(e.link),o.close()},countMessage++}navigator.detectBrowser=function(){var e,o=navigator.userAgent,r=o.match(/SeaMonkey|Maxthon|Vivaldi|GNUIceCat|ComodoDragon|ComodoIceDragon|Sleipnir|Tor|PaleMoon|iCab|Dooble|TenFourFox|QupZilla|CrustaBrowser|OtterBrowser|Brave|TheClassicBrowser|PolarityBrowser|Chromium|Sogoubrowser|RoccatBrowser|360SecurityBrowser|SlimBrowser|Slimjet|360ExtremeExplorer|Konqueror|Lunascape|Midori|Amaya|Links|DilloWebBrowser|Waterfox|Epic|IronBrowser|AvantBrowser|Fluid|Kylo|Swiftfox|GreenBrowser|K-Meleon|NetSurf|BaiduBrowser|TorchBrowser|BriskBard|surf|Citrio|uzbl|Conkeror|Ibrowse|UCBrowser|Nano|OmniWeb|Arachne|ShenzBrowser|Browse3D|BittyBrowser|ElinksTextWWWBrowser|CốcCốcBrowser|Lynx|TheWorldBrowser|Classilla|TT|Pinkbrowser|QtWeb|Stainless|KidZui|MenuBox|WebPositive|Wyzomediabrowser|xombrero|CometBird|AWeb|SafeZoneBrowser|ZACBrowser|AcooBrowser|Timberwolf|Kazehakase|rekonq|Iceweasel|NetscapeNavigator|Swiftweasel|Galeon|Flock(webbrowser)|Camino|Arora|TitanBrowser|Shiira|BeonexCommunicator|xBBrowser|AOLExplorer|spacetime|NeoPlanet/i)||[];return r.length?r[0]:"Chrome"===(r=o.match(/(opera|chrome|safari|firefox(?=\/))\/?\s*(\d+)/i))[1]&&null!=(e=o.match(/\b(OPR)\/(\d+)/))?e[1].replace("OPR","Opera"):"Chrome"===r[1]&&null!=(e=o.match(/\b(YaBrowser)\/(\d+)/))?e[1].replace("YaBrowser","Yandex"):(r=r[2]?[r[1],r[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(e=o.match(/version\/(\d+)/i))&&r.splice(1,1,e[1]),r[0])}();var browser=navigator.detectBrowser,diveceImg=$(".js-push-photo-device-img"),deviceSupport=$(".js-push-photo-device-support"),pushTryBtn=$(".js-push-photo-btn"),otherDevice=$(".js-push-photo-other-device");switch(browser){case"Chrome":diveceImg.attr("src","img/welcome/chrome.svg");break;case"Opera":diveceImg.attr("src","img/welcome/opera.svg");break;case"Yandex":diveceImg.attr("src","img/welcome/yandex.svg");break;case"Firefox":diveceImg.attr("src","img/welcome/firefox.svg");break;case"Safari":diveceImg.attr("src","img/welcome/safari.svg");break;default:otherDevice.css("display","block"),deviceSupport.css("display","none"),diveceImg.css("display","none"),pushTryBtn.css("display","none")}var isPushPage=$("body").hasClass("push-page");if(isPushPage){var pushPhotoBlock=$(".js-push-photo").offset().top,pushExample=$(".js-push-photo-scheme");$(window).scroll(function(){$(this).scrollTop()+200>=pushPhotoBlock&&window.matchMedia(md).matches&&pushExample.removeClass("push-photo__description--hidden").animate({top:"20%",left:"initial",right:0},1500)})}var countMessage=0;
function set_alias_soon(){var o=$("#soon-email").val();Gravitec.push(["isSubscribed",function(s){Gravitec.push(["setAlias",o])}])}function set_alias_soon_check(){soonForm.submit(function(o){o.preventDefault();{if(serverReachable()){var s=soonForm.serialize();return $.ajax({type:"POST",url:"php/soon.php",dataType:"json",data:s,success:function(o){}}),setTimeout(function(){soonForm.trigger("reset")},1e3),set_alias_soon(),!0}offlineMessage()}})}var soonForm=$("#soon-form"),emailSoon=$("#soon-email"),messageSoon=$("#soon-message");inputError(emailSoon);
function addZero(e){return e<10&&(e="0"+e),e}setInterval(function(){var e,s=$(".js-time"),i=new Date,t=i.getMinutes(),n=i.getHours();e=(n=addZero(n))+":"+(t=addZero(t)),s.text(e)},1e3);var counter,viberCheckbox=$(".js-viber-checkbox"),viberCheckboxClass="viber-messages__description-item--checked",viberElements=$(".js-viber-elements"),viberElementsClass="viber-example__message-item--visible";$.each(viberCheckbox,function(e){$(this).click(function(){window.matchMedia(md).matches&&($(this).toggleClass(viberCheckboxClass),$(viberElements[e]).toggleClass(viberElementsClass),counter=0,$.each(viberElements,function(e){$(this).hasClass(viberElementsClass)||counter++}),4==counter?$(".js-viber-no-elements").addClass(viberElementsClass):$(".js-viber-no-elements").removeClass(viberElementsClass))})}),$(window).on("load resize",function(){window.matchMedia(md).matches||$.each(viberCheckbox,function(e){$(this).addClass(viberCheckboxClass),$(viberElements[e]).addClass(viberElementsClass),$(".js-viber-no-elements").removeClass(viberElementsClass),counter=0})});
var viberSoonCheckbox=$(".js-viber-form-soon-checkbox");viberSoonCheckbox.on("click",function(){viberSoonCheckbox.toggleClass("viber-soon__checkbox-title--checked")});var viberSoonForm=$("#viber-soon-form");viberFormSuccess=$(".js-viber-soon-form-success"),viberSoonEmail=$("#viber-soon-email"),inputError(viberSoonEmail),viberSoonForm.submit(function(o){o.preventDefault();$("#viber-soon-email").val();var e=[viberSoonEmail,$("#viber-soon-submit")],i=viberSoonForm.serialize();$.ajax({type:"POST",url:"php/viber.php",dataType:"json",data:i,success:function(o){}}),$.each(e,function(o){e[o].attr("disabled","disabled"),viberSoonCheckbox.css("opacity","0.1")}),viberFormSuccess.fadeIn(500).css({display:"flex"}),setTimeout(function(){$.each(e,function(o){e[o].removeAttr("disabled").removeClass("input-invalid"),viberSoonCheckbox.css("opacity","1")}),viberSoonForm.trigger("reset"),$("#viber-soon-submit").blur()},5e3),setTimeout(function(){viberFormSuccess.fadeOut(500)},5200)});
var canalForm=$(".js-canal-form"),canalFormEmail=$(".js-canal-email");inputError(canalFormEmail),canalForm.submit(function(a){a.preventDefault();var n=canalForm.serialize();return console.log(n),$.ajax({type:"POST",url:"php/canal-page.php",dataType:"json",data:n,success:function(a){}}),setTimeout(function(){canalForm.trigger("reset")},1e3),!0});
