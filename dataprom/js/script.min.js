...
$.fn.clickToggle=function(t,i){var n=[i,t];return this.on("click",function(){n[this._tog^=1].call(this)})};var sm="(min-width: 576px)",md="(min-width: 768px)",lg="(min-width: 992px)",xl="(min-width: 1200px)",xxl="(min-width: 1800px)",container={sm:550,md:744,lg:990,xl:1170,xxl:1620},body=$("body"),header=$("header"),footer=$("footer"),main=$("main"),fixedBody="body-fixed",bluredContent="content-blur";function inputError(t,n){t.on("focusin",function(){$(this).removeClass(n)}).on("focusout",function(){var t=$(this).val(),i=new RegExp($(this).attr("pattern"));(!$(this).attr("required")||0!=t&&i.test(t))&&(0==t||i.test(t))?$(this).removeClass(n):$(this).addClass(n)})}var errorClass="error";
!function(Te,e,ke){"use strict";function xe(o,e,n){function s(e){var t=K.length;if(R.old=Te.extend({},R),F=Y?0:M[H.horizontal?"width":"height"](),$=W[H.horizontal?"width":"height"](),L=Y?o:j[H.horizontal?"outerWidth":"outerHeight"](),K.length=0,R.start=0,R.end=nt(L-F,0),le){_.length,V=j.children(H.itemSelector),_.length=0;var d,u=Ne(j,H.horizontal?"paddingLeft":"paddingTop"),f=Ne(j,H.horizontal?"paddingRight":"paddingBottom"),a="border-box"===Te(V).css("boxSizing"),v="none"!==V.css("float"),h=0,p=V.length-1;L=0,V.each(function(e,t){var a=Te(t),n=t.getBoundingClientRect(),i=at(H.horizontal?n.width||n.right-n.left:n.height||n.bottom-n.top),r=Ne(a,H.horizontal?"marginLeft":"marginTop"),s=Ne(a,H.horizontal?"marginRight":"marginBottom"),o=i+r+s,l=!r||!s,c={};c.el=t,c.size=l?i:o,c.half=c.size/2,c.start=L+(l?r:0),c.center=c.start-at(F/2-c.size/2),c.end=c.start-F+c.size,e||(L+=u),L+=o,H.horizontal||v||s&&r&&0<e&&(L-=it(r,s)),e===p&&(c.end+=f,L+=f,h=l?s:0),_.push(c),d=c}),j[0].style[H.horizontal?"width":"height"]=(a?L:L-u-f)+"px",L-=h,_.length?(R.start=_[0][se?"center":"start"],R.end=se?d.center:F<L?d.end:R.start):R.start=R.end=0}if(R.center=at(R.end/2+R.start/2),m(),U.length&&0<$&&(H.dynamicHandle?(Q=He(Q=R.start===R.end?$:at($*F/L),H.minHandleSize,$),U[0].style[H.horizontal?"width":"height"]=Q+"px"):Q=U[H.horizontal?"outerWidth":"outerHeight"](),Z.end=$-Q,ze||c()),!Y&&0<F){var n=R.start,i="";if(le)Te.each(_,function(e,t){se?K.push(t.center):t.start+t.size>n&&n<=R.end&&(n=t.start,K.push(n),(n+=F)>R.end&&n<R.end+F&&K.push(R.end))});else for(;n-F<R.end;)K.push(n),n+=F;if(G[0]&&t!==K.length){for(var r=0;r<K.length;r++)i+=H.pageBuilder.call(X,r);(J=G.html(i).children()).eq(ee.activePage).addClass(H.activeClass)}}if(ee.slideeSize=L,ee.frameSize=F,ee.sbSize=$,ee.handleSize=Q,le){e&&null!=H.startAt&&(g(H.startAt),X[oe?"toCenter":"toStart"](H.startAt));var s=_[ee.activeItem];l(oe&&s?s.center:He(R.dest,R.start,R.end))}else e?null!=H.startAt&&l(H.startAt,1):l(He(R.dest,R.start,R.end));q("load")}function l(e,t,a){if(le&&be.released&&!a){var n=f(e),i=e>R.start&&e<R.end;oe?(i&&(e=_[n.centerItem].center),se&&H.activateMiddle&&g(n.centerItem)):i&&(e=_[n.firstItem].start)}be.init&&be.slidee&&H.elasticBounds?e>R.end?e=R.end+(e-R.end)/6:e<R.start&&(e=R.start+(e-R.start)/6):e=He(e,R.start,R.end),we.start=+new Date,we.time=0,we.from=R.cur,we.to=e,we.delta=e-R.cur,we.tweesing=be.tweese||be.init&&!be.slidee,we.immediate=!we.tweesing&&(t||be.init&&be.slidee||!H.speed),be.tweese=0,e!==R.dest&&(R.dest=e,q("change"),ze||r()),p(),m(),v(),J[0]&&ye.page!==ee.activePage&&(ye.page=ee.activePage,J.removeClass(H.activeClass).eq(ee.activePage).addClass(H.activeClass),q("activePage",ye.page))}function r(){if(X.initialized){if(!ze)return ze=Re(r),void(be.released&&q("moveStart"));we.immediate?R.cur=we.to:we.tweesing?(we.tweeseDelta=we.to-R.cur,_e(we.tweeseDelta)<.1?R.cur=we.to:R.cur+=we.tweeseDelta*(be.released?H.swingSpeed:H.syncSpeed)):(we.time=it(+new Date-we.start,H.speed),R.cur=we.from+we.delta*Te.easing[H.easing](we.time/H.speed,we.time,0,1,H.speed)),we.to===R.cur?(R.cur=we.to,be.tweese=ze=0):ze=Re(r),q("move"),Y||(Ye?j[0].style[Ye]=Me+(H.horizontal?"translateX":"translateY")+"("+-R.cur+"px)":j[0].style[H.horizontal?"left":"top"]=-at(R.cur)+"px"),!ze&&be.released&&q("moveEnd"),c()}}function c(){U.length&&(Z.cur=R.start===R.end?0:((be.init&&!be.slidee?R.dest:R.cur)-R.start)/(R.end-R.start)*Z.end,Z.cur=He(at(Z.cur),Z.start,Z.end),ye.hPos!==Z.cur&&(ye.hPos=Z.cur,Ye?U[0].style[Ye]=Me+(H.horizontal?"translateX":"translateY")+"("+Z.cur+"px)":U[0].style[H.horizontal?"left":"top"]=Z.cur+"px"))}function t(){Ie.speed&&R.cur!==(0<Ie.speed?R.end:R.start)||X.stop(),Be=be.init?Re(t):0,Ie.now=+new Date,Ie.pos=R.cur+(Ie.now-Ie.lastTime)/1e3*Ie.speed,l(be.init?Ie.pos:at(Ie.pos)),be.init||R.cur!==R.dest||q("moveEnd"),Ie.lastTime=Ie.now}function a(e,t,a){if("boolean"===De(t)&&(a=t,t=ke),t===ke)l(R[e],a);else{if(oe&&"center"!==e)return;var n=X.getPos(t);n&&l(n[e],a,!oe)}}function d(e){return null!=e?Oe(e)?0<=e&&e<_.length?e:-1:V.index(e):-1}function u(e){return d(Oe(e)&&e<0?e+_.length:e)}function g(e,t){var a=d(e);return!(!le||a<0)&&((ye.active!==a||t)&&(V.eq(ee.activeItem).removeClass(H.activeClass),V.eq(a).addClass(H.activeClass),ye.active=ee.activeItem=a,v(),q("active",a)),a)}function f(e){e=He(Oe(e)?e:R.dest,R.start,R.end);var t={},a=se?0:F/2;if(!Y)for(var n=0,i=K.length;n<i;n++){if(e>=R.end||n===K.length-1){t.activePage=K.length-1;break}if(e<=K[n]+a){t.activePage=n;break}}if(le){for(var r=!1,s=!1,o=!1,l=0,c=_.length;l<c;l++)if(!1===r&&e<=_[l].start+_[l].half&&(r=l),!1===o&&e<=_[l].center+_[l].half&&(o=l),l===c-1||e<=_[l].end+_[l].half){s=l;break}t.firstItem=Oe(r)?r:0,t.centerItem=Oe(o)?o:t.firstItem,t.lastItem=Oe(s)?s:t.centerItem}return t}function m(e){Te.extend(ee,f(e))}function v(){var e=R.dest<=R.start,t=R.dest>=R.end,a=(e?1:0)|(t?2:0);if(ye.slideePosState!==a&&(ye.slideePosState=a,pe.is("button,input")&&pe.prop("disabled",e),ge.is("button,input")&&ge.prop("disabled",t),pe.add(fe)[e?"addClass":"removeClass"](H.disabledClass),ge.add(ue)[t?"addClass":"removeClass"](H.disabledClass)),ye.fwdbwdState!==a&&be.released&&(ye.fwdbwdState=a,fe.is("button,input")&&fe.prop("disabled",e),ue.is("button,input")&&ue.prop("disabled",t)),le&&null!=ee.activeItem){var n=0===ee.activeItem,i=ee.activeItem>=_.length-1,r=(n?1:0)|(i?2:0);ye.itemsButtonState!==r&&(ye.itemsButtonState=r,ve.is("button,input")&&ve.prop("disabled",n),he.is("button,input")&&he.prop("disabled",i),ve[n?"addClass":"removeClass"](H.disabledClass),he[i?"addClass":"removeClass"](H.disabledClass))}}function i(e,t,a){if(e=u(e),t=u(t),-1<e&&-1<t&&e!==t&&(!a||t!==e-1)&&(a||t!==e+1)){V.eq(e)[a?"insertAfter":"insertBefore"](_[t].el);var n=e<t?e:a?t:t-1,i=t<e?e:a?t+1:t,r=t<e;null!=ee.activeItem&&(e===ee.activeItem?ye.active=ee.activeItem=a?r?t+1:t:r?t:t-1:ee.activeItem>n&&ee.activeItem<i&&(ye.active=ee.activeItem+=r?1:-1)),s()}}function h(e,t){for(var a=0,n=me[e].length;a<n;a++)if(me[e][a]===t)return a;return-1}function p(){be.released&&!X.isPaused&&X.resume()}function y(e){return at(He(e,Z.start,Z.end)/Z.end*(R.end-R.start))+R.start}function w(){be.history[0]=be.history[1],be.history[1]=be.history[2],be.history[2]=be.history[3],be.history[3]=be.delta}function I(e){be.released=0,be.source=e,be.slidee="slidee"===e}function b(e){var t="touchstart"===e.type,a=e.data.source,n="slidee"===a;be.init||!t&&C(e.target)||("handle"!==a||H.dragHandle&&Z.start!==Z.end)&&(!n||(t?H.touchDragging:H.mouseDragging&&e.which<2))&&(t||Ae(e),I(a),be.init=0,be.$source=Te(e.target),be.touch=t,be.pointer=t?e.originalEvent.touches[0]:e,be.initX=be.pointer.pageX,be.initY=be.pointer.pageY,be.initPos=n?R.cur:Z.cur,be.start=+new Date,be.time=0,be.path=0,be.delta=0,be.locked=0,be.history=[0,0,0,0],be.pathToLock=n?t?30:10:0,We.on(t?Qe:$e,P),X.pause(1),(n?j:U).addClass(H.draggedClass),q("moveStart"),n&&(Ce=setInterval(w,10)))}function P(e){if(be.released="mouseup"===e.type||"touchend"===e.type,be.pointer=be.touch?e.originalEvent[be.released?"changedTouches":"touches"][0]:e,be.pathX=be.pointer.pageX-be.initX,be.pathY=be.pointer.pageY-be.initY,be.path=et(tt(be.pathX,2)+tt(be.pathY,2)),be.delta=H.horizontal?be.pathX:be.pathY,be.released||!(be.path<1)){if(!be.init){if(be.path<H.dragThreshold)return be.released?z():ke;if(!(H.horizontal?_e(be.pathX)>_e(be.pathY):_e(be.pathX)<_e(be.pathY)))return z();be.init=1}Ae(e),!be.locked&&be.path>be.pathToLock&&be.slidee&&(be.locked=1,be.$source.on(Ge,Ee)),be.released&&(z(),H.releaseSwing&&be.slidee&&(be.swing=(be.delta-be.history[0])/40*300,be.delta+=be.swing,be.tweese=10<_e(be.swing))),l(be.slidee?at(be.initPos-be.delta):y(be.initPos+be.delta))}}function z(){clearInterval(Ce),be.released=!0,We.off(be.touch?Qe:$e,P),(be.slidee?j:U).removeClass(H.draggedClass),setTimeout(function(){be.$source.off(Ge,Ee)}),R.cur===R.dest&&be.init&&q("moveEnd"),X.resume(1),be.init=0}function C(e){return~Te.inArray(e.nodeName,Ke)||Te(e).is(H.interactive)}function S(){X.stop(),We.off("mouseup",S)}function B(e){switch(Ae(e),this){case ue[0]:case fe[0]:X.moveBy(ue.is(this)?H.moveBy:-H.moveBy),We.on("mouseup",S);break;case ve[0]:X.prev();break;case he[0]:X.next();break;case pe[0]:X.prevPage();break;case ge[0]:X.nextPage()}}function T(e){e.originalEvent[Fe]=X;var t,a=+new Date;if(rt+H.scrollHijack>a&&ce[0]!==document&&ce[0]!==window)rt=a;else if(H.scrollBy&&R.start!==R.end){var n=(t=e.originalEvent,Pe.curDelta=(H.horizontal?t.deltaY||t.deltaX:t.deltaY)||-t.wheelDelta,Pe.curDelta/=1===t.deltaMode?3:100,le?(je=+new Date,Pe.last<je-Pe.resetTime&&(Pe.delta=0),Pe.last=je,Pe.delta+=Pe.curDelta,_e(Pe.delta)<1?Pe.finalDelta=0:(Pe.finalDelta=at(Pe.delta/1),Pe.delta%=1),Pe.finalDelta):Pe.curDelta);(H.scrollTrap||0<n&&R.dest<R.end||n<0&&R.dest>R.start)&&Ae(e,1),X.slideBy(H.scrollBy*n)}}function k(e){H.clickBar&&e.target===W[0]&&(Ae(e),l(y((H.horizontal?e.pageX-W.offset().left:e.pageY-W.offset().top)-Q/2)))}function x(e){if(H.keyboardNavBy)switch(e.which){case H.horizontal?37:38:Ae(e),X["pages"===H.keyboardNavBy?"prevPage":"prev"]();break;case H.horizontal?39:40:Ae(e),X["pages"===H.keyboardNavBy?"nextPage":"next"]()}}function D(e){return C(this)?void(e.originalEvent[Fe+"ignore"]=!0):void(this.parentNode!==j[0]||e.originalEvent[Fe+"ignore"]||X.activate(this))}function A(){this.parentNode===G[0]&&X.activatePage(J.index(this))}function E(e){H.pauseOnHover&&X["mouseenter"===e.type?"pause":"resume"](2)}function q(e,t){if(me[e]){for(N=me[e].length,Ve.length=0,O=0;O<N;O++)Ve.push(me[e][O]);for(O=0;O<N;O++)Ve[O].call(X,e,t)}}if(!(this instanceof xe))return new xe(o,e,n);var O,N,H=Te.extend({},xe.defaults,e),X=this,Y=Oe(o),M=Te(o),j=H.slidee?Te(H.slidee).eq(0):M.children().eq(0),F=0,L=0,R={start:0,center:0,end:0,cur:0,dest:0},W=Te(H.scrollBar).eq(0),U=W.children().eq(0),$=0,Q=0,Z={start:0,end:0,cur:0},G=Te(H.pagesBar),J=0,K=[],V=0,_=[],ee={firstItem:0,lastItem:0,centerItem:0,activeItem:null,activePage:0},te=new Xe(M[0]),ae=new Xe(j[0]),ne=new Xe(W[0]),ie=new Xe(U[0]),re="basic"===H.itemNav,se="forceCentered"===H.itemNav,oe="centered"===H.itemNav||se,le=!Y&&(re||oe||se),ce=H.scrollSource?Te(H.scrollSource):M,de=H.dragSource?Te(H.dragSource):M,ue=Te(H.forward),fe=Te(H.backward),ve=Te(H.prev),he=Te(H.next),pe=Te(H.prevPage),ge=Te(H.nextPage),me={},ye={},we={},Ie={},be={released:1},Pe={last:0,delta:0,resetTime:200},ze=0,Ce=0,Se=0,Be=0;Y||(o=M[0]),X.initialized=0,X.frame=o,X.slidee=j[0],X.pos=R,X.rel=ee,X.items=_,X.pages=K,X.isPaused=0,X.options=H,X.dragging=be,X.reload=function(){s()},X.getPos=function(e){if(le){var t=d(e);return-1!==t&&_[t]}var a=j.find(e).eq(0);if(a[0]){var n=H.horizontal?a.offset().left-j.offset().left:a.offset().top-j.offset().top,i=a[H.horizontal?"outerWidth":"outerHeight"]();return{start:n,center:n-F/2+i/2,end:n-F+i,size:i}}return!1},X.moveBy=function(e){Ie.speed=e,!be.init&&Ie.speed&&R.cur!==(0<Ie.speed?R.end:R.start)&&(Ie.lastTime=+new Date,Ie.startPos=R.cur,I("button"),be.init=1,q("moveStart"),Le(Be),t())},X.stop=function(){"button"===be.source&&(be.init=0,be.released=1)},X.prev=function(){X.activate(null==ee.activeItem?0:ee.activeItem-1)},X.next=function(){X.activate(null==ee.activeItem?0:ee.activeItem+1)},X.prevPage=function(){X.activatePage(ee.activePage-1)},X.nextPage=function(){X.activatePage(ee.activePage+1)},X.slideBy=function(e,t){e&&(le?X[oe?"toCenter":"toStart"](He((oe?ee.centerItem:ee.firstItem)+H.scrollBy*e,0,_.length)):l(R.dest+e,t))},X.slideTo=function(e,t){l(e,t)},X.toStart=function(e,t){a("start",e,t)},X.toEnd=function(e,t){a("end",e,t)},X.toCenter=function(e,t){a("center",e,t)},X.getIndex=d,X.activate=function(e,t){var a=g(e);H.smart&&!1!==a&&(oe?X.toCenter(a,t):a>=ee.lastItem?X.toStart(a,t):a<=ee.firstItem?X.toEnd(a,t):p())},X.activatePage=function(e,t){Oe(e)&&l(K[He(e,0,K.length-1)],t)},X.resume=function(e){H.cycleBy&&H.cycleInterval&&("items"!==H.cycleBy||_[0]&&null!=ee.activeItem)&&!(e<X.isPaused)&&(X.isPaused=0,Se?Se=clearTimeout(Se):q("resume"),Se=setTimeout(function(){switch(q("cycle"),H.cycleBy){case"items":X.activate(ee.activeItem>=_.length-1?0:ee.activeItem+1);break;case"pages":X.activatePage(ee.activePage>=K.length-1?0:ee.activePage+1)}},H.cycleInterval))},X.pause=function(e){e<X.isPaused||(X.isPaused=e||100,Se&&(Se=clearTimeout(Se),q("pause")))},X.toggle=function(){X[Se?"pause":"resume"]()},X.set=function(e,t){Te.isPlainObject(e)?Te.extend(H,e):H.hasOwnProperty(e)&&(H[e]=t)},X.add=function(e,t){var a=Te(e);le?(null==t||!_[0]||t>=_.length?a.appendTo(j):_.length&&a.insertBefore(_[t].el),null!=ee.activeItem&&t<=ee.activeItem&&(ye.active=ee.activeItem+=a.length)):j.append(a),s()},X.remove=function(e){if(le){var t=u(e);if(-1<t){V.eq(t).remove();var a=t===ee.activeItem;null!=ee.activeItem&&t<ee.activeItem&&(ye.active=--ee.activeItem),s(),a&&(ye.active=null,X.activate(ee.activeItem))}}else Te(e).remove(),s()},X.moveAfter=function(e,t){i(e,t,1)},X.moveBefore=function(e,t){i(e,t)},X.on=function(e,t){if("object"===De(e))for(var a in e)e.hasOwnProperty(a)&&X.on(a,e[a]);else if("function"===De(t))for(var n=e.split(" "),i=0,r=n.length;i<r;i++)me[n[i]]=me[n[i]]||[],-1===h(n[i],t)&&me[n[i]].push(t);else if("array"===De(t))for(var s=0,o=t.length;s<o;s++)X.on(e,t[s])},X.one=function(t,a){X.on(t,function e(){a.apply(X,arguments),X.off(t,e)})},X.off=function(e,t){if(t instanceof Array)for(var a=0,n=t.length;a<n;a++)X.off(e,t[a]);else for(var i=e.split(" "),r=0,s=i.length;r<s;r++)if(me[i[r]]=me[i[r]]||[],null==t)me[i[r]].length=0;else{var o=h(i[r],t);-1!==o&&me[i[r]].splice(o,1)}},X.destroy=function(){return xe.removeInstance(o),ce.add(U).add(W).add(G).add(ue).add(fe).add(ve).add(he).add(pe).add(ge).off("."+Fe),We.off("keydown",x),ve.add(he).add(pe).add(ge).removeClass(H.disabledClass),V&&null!=ee.activeItem&&V.eq(ee.activeItem).removeClass(H.activeClass),G.empty(),Y||(M.off("."+Fe),te.restore(),ae.restore(),ne.restore(),ie.restore(),Te.removeData(o,Fe)),_.length=K.length=0,ye={},X.initialized=0,X},X.init=function(){if(!X.initialized){if(xe.getInstance(o))throw new Error("There is already a Sly instance on this element");xe.storeInstance(o,X),X.on(n);var e=["overflow","position"],t=["position","webkitTransform","msTransform","transform","left","top","width","height"];te.save.apply(te,e),ne.save.apply(ne,e),ae.save.apply(ae,t),ie.save.apply(ie,t);var a=U;return Y||(a=a.add(j),M.css("overflow","hidden"),Ye||"static"!==M.css("position")||M.css("position","relative")),Ye?Me&&a.css(Ye,Me):("static"===W.css("position")&&W.css("position","relative"),a.css({position:"absolute"})),H.forward&&ue.on(Je,B),H.backward&&fe.on(Je,B),H.prev&&ve.on(Ge,B),H.next&&he.on(Ge,B),H.prevPage&&pe.on(Ge,B),H.nextPage&&ge.on(Ge,B),ce.on(Ze,T),W[0]&&W.on(Ge,k),le&&H.activateOn&&M.on(H.activateOn+"."+Fe,"*",D),G[0]&&H.activatePageOn&&G.on(H.activatePageOn+"."+Fe,"*",A),de.on(Ue,{source:"slidee"},b),U&&U.on(Ue,{source:"handle"},b),We.on("keydown",x),Y||(M.on("mouseenter."+Fe+" mouseleave."+Fe,E),M.on("scroll."+Fe,qe)),X.initialized=1,s(!0),H.cycleBy&&!Y&&X[H.startPaused?"pause":"resume"](),X}}}function De(e){return null==e?String(e):"object"==typeof e||"function"==typeof e?Object.prototype.toString.call(e).match(/\s([a-z]+)/i)[1].toLowerCase()||"object":typeof e}function Ae(e,t){e.preventDefault(),t&&e.stopPropagation()}function Ee(e){Ae(e,1),Te(this).off(e.type,Ee)}function qe(){this.scrollLeft=0,this.scrollTop=0}function Oe(e){return!isNaN(parseFloat(e))&&isFinite(e)}function Ne(e,t){return 0|at(String(e.css(t)).replace(/[^\-0-9.]/g,""))}function He(e,t,a){return e<t?t:a<e?a:e}function Xe(t){var a={style:{},save:function(){if(t&&t.nodeType){for(var e=0;e<arguments.length;e++)a.style[arguments[e]]=t.style[arguments[e]];return a}},restore:function(){if(t&&t.nodeType){for(var e in a.style)a.style.hasOwnProperty(e)&&(t.style[e]=a.style[e]);return a}}};return a}var Ye,Me,je,Fe="sly",Le=e.cancelAnimationFrame||e.cancelRequestAnimationFrame,Re=e.requestAnimationFrame,We=Te(document),Ue="touchstart."+Fe+" mousedown."+Fe,$e="mousemove."+Fe+" mouseup."+Fe,Qe="touchmove."+Fe+" touchend."+Fe,Ze=(document.implementation.hasFeature("Event.wheel","3.0")?"wheel.":"mousewheel.")+Fe,Ge="click."+Fe,Je="mousedown."+Fe,Ke=["INPUT","SELECT","BUTTON","TEXTAREA"],Ve=[],_e=Math.abs,et=Math.sqrt,tt=Math.pow,at=Math.round,nt=Math.max,it=Math.min,rt=0;We.on(Ze,function(e){var t=e.originalEvent[Fe],a=+new Date;(!t||t.options.scrollHijack<a-rt)&&(rt=a)}),xe.getInstance=function(e){return Te.data(e,Fe)},xe.storeInstance=function(e,t){return Te.data(e,Fe,t)},xe.removeInstance=function(e){return Te.removeData(e,Fe)},function(t){Re=t.requestAnimationFrame||t.webkitRequestAnimationFrame||function(e){var t=(new Date).getTime(),a=Math.max(0,16-(t-i)),n=setTimeout(e,a);return i=t,n};var i=(new Date).getTime(),a=t.cancelAnimationFrame||t.webkitCancelAnimationFrame||t.clearTimeout;Le=function(e){a.call(t,e)}}(window),function(){function e(e){for(var t=0,a=i.length;t<a;t++){var n=i[t]?i[t]+e.charAt(0).toUpperCase()+e.slice(1):e;if(null!=r.style[n])return n}}var i=["","Webkit","Moz","ms","O"],r=document.createElement("div");Ye=e("transform"),Me=e("perspective")?"translateZ(0) ":""}(),e.Sly=xe,Te.fn.sly=function(n,i){var r,s;return Te.isPlainObject(n)||(("string"===De(n)||!1===n)&&(r=!1===n?"destroy":n,s=Array.prototype.slice.call(arguments,1)),n={}),this.each(function(e,t){var a=xe.getInstance(t);a||r?a&&r&&a[r]&&a[r].apply(a,s):a=new xe(t,n,i).init()})},xe.defaults={slidee:null,horizontal:!1,itemNav:null,itemSelector:null,smart:!1,activateOn:null,activateMiddle:!1,scrollSource:null,scrollBy:0,scrollHijack:300,scrollTrap:!1,dragSource:null,mouseDragging:!1,touchDragging:!1,releaseSwing:!1,swingSpeed:.2,elasticBounds:!1,dragThreshold:3,interactive:null,scrollBar:null,dragHandle:!1,dynamicHandle:!1,minHandleSize:50,clickBar:!1,syncSpeed:.5,pagesBar:null,activatePageOn:null,pageBuilder:function(e){return"<li>"+(e+1)+"</li>"},forward:null,backward:null,prev:null,next:null,prevPage:null,nextPage:null,cycleBy:null,cycleInterval:5e3,pauseOnHover:!1,startPaused:!1,moveBy:300,speed:0,easing:"swing",startAt:null,keyboardNavBy:null,draggedClass:"dragged",activeClass:"active",disabledClass:"disabled"}}(jQuery,window);

$(function(){var e=$(".b-slider"),s=$(".btn-slider-wrap"),r=$(".btn-slider.btn-slider--prev"),i=$(".btn-slider.btn-slider--next"),t=$(".b-slider-text");t.length?(e.slick({appendArrows:s,prevArrow:r,mobileFirst:!0,nextArrow:i,slidesToShow:1,asNavFor:".b-slider-text",responsive:[{breakpoint:767,settings:{slidesToShow:2}},{breakpoint:1199,settings:{variableWidth:!0}}]}),t.slick({arrows:!1,fade:!0,slidesToShow:1,asNavFor:".b-slider"})):e.slick({appendArrows:s,prevArrow:r,mobileFirst:!0,nextArrow:i,slidesToShow:1,responsive:[{breakpoint:767,settings:{slidesToShow:2}},{breakpoint:1199,settings:{variableWidth:!0}}]})});


$(function(){var s=$("#contact-form"),t=$("#contact-email"),n=$("#contact-name"),o=s.attr("action");inputError(t,errorClass),inputError(n,errorClass),s.submit(function(a){if(a.preventDefault(),0==t.val()&&t.addClass(errorClass),0==n.val()&&n.addClass(errorClass),!s.find($(".form-input")).hasClass(errorClass)){var r=s.serialize();$.ajax({type:"POST",url:o,dataType:"json",data:r,success:function(a){}})}})});

$(function(){$(".js-year").text((new Date).getFullYear());var s=$("#subscribe-form"),e=$("#subscribe-email"),t=s.attr("action");inputError(e,errorClass),s.submit(function(r){if(r.preventDefault(),0==e.val()&&e.addClass(errorClass),!s.find($(".form-input")).hasClass(errorClass)){var a=s.serialize();return $.ajax({type:"POST",url:t,dataType:"json",data:a,success:function(r){}}),!0}})});
$(function(){var e=$(".js-hamburger"),o=($(".js-menu-item"),$(".js-menu-item a")),a=$(".js-header"),t="active",s="on-scroll";function i(o){o.toggleClass(t),body.toggleClass(fixedBody)}e.clickToggle(function(){i($(this))},function(){i($(this))}),$(window).scroll(function(){25<$(this).scrollTop()?a.addClass(s):a.removeClass(s)}),$(window).on("resize",function(){window.matchMedia(lg).matches&&body.hasClass(fixedBody)&&e.hasClass(t)&&($(".js-modal").hasClass(t)||body.removeClass(fixedBody),e.removeClass(t))}),o.click(function(){var o,s=$(this).attr("href");return o="#home"==s?0:$(s).offset().top-a.height(),$("html:not(:animated),body:not(:animated)").animate({scrollTop:o},800),window.matchMedia(lg).matches||(body.removeClass(fixedBody),e.removeClass(t)),!1}),$(window).on("load resize",function(){a.height(),o.map(function(){var o=$($(this).attr("href"));if(o.length)return o});25<$(this).scrollTop()&&a.addClass(s)})});

$(function(){var n=$(".js-modal"),o=$(".js-modal-content"),e=".js-modal-window",t="active",l=$(".js-modal-close"),a={login:{btn:$(".js-login-btn"),modal:$("#login")},order:{btn:$(".js-get-started"),modal:$("#order")},fashion:{btn:$(".js-fashion"),modal:$("#fashion")},perfumery:{btn:$(".js-perfumery"),modal:$("#perfumery")},outdoor:{btn:$(".js-outdoor"),modal:$("#outdoor")},electronics:{btn:$(".js-electronics"),modal:$("#electronics")},grocery:{btn:$(".js-grocery"),modal:$("#grocery")},client1:{btn:$(".js-client-1"),modal:$("#client-1")},client2:{btn:$(".js-client-2"),modal:$("#client-2")},client3:{btn:$(".js-client-3"),modal:$("#client-3")},client4:{btn:$(".js-client-4"),modal:$("#client-4")},client5:{btn:$(".js-client-5"),modal:$("#client-5")}},d=function(n){n.addClass(t),n.find(e).animate({top:0},300),body.addClass(fixedBody),header.addClass(bluredContent),footer.addClass(bluredContent),main.addClass(bluredContent)},i=function(){n.removeClass(t),n.find(e).animate({top:"-100vh"},300),$(".js-hamburger").hasClass(t)||body.removeClass(fixedBody),header.removeClass(bluredContent),footer.removeClass(bluredContent),main.removeClass(bluredContent)};function r(n,o){n.click(function(n){n.preventDefault(),d(o)})}o.click(function(n){n.stopPropagation()}),r(a.login.btn,a.login.modal),r(a.order.btn,a.order.modal),r(a.fashion.btn,a.fashion.modal),r(a.perfumery.btn,a.perfumery.modal),r(a.outdoor.btn,a.outdoor.modal),r(a.electronics.btn,a.electronics.modal),r(a.grocery.btn,a.grocery.modal),r(a.client1.btn,a.client1.modal),r(a.client2.btn,a.client2.modal),r(a.client3.btn,a.client3.modal),r(a.client4.btn,a.client4.modal),r(a.client5.btn,a.client5.modal),l.click(i),n.click(i)});
...
$(function(){var s=$("#order-form"),e=$("#order-email"),o=$("#order-name"),r=$("#order-tel"),t=s.attr("action");inputError(e,errorClass),inputError(o,errorClass),inputError(r,errorClass),s.submit(function(r){if(r.preventDefault(),0==e.val()&&e.addClass(errorClass),0==o.val()&&o.addClass(errorClass),!s.find($(".form-input")).hasClass(errorClass)){var a=s.serialize();$.ajax({type:"POST",url:t,dataType:"json",data:a,success:function(r){}})}})});



$(function(){var a=$(".js-slider-frame"),i=$(".js-scrollbar"),e=new Sly(a,{horizontal:1,itemNav:"basic",smart:1,activateOn:"click",mouseDragging:1,touchDragging:1,releaseSwing:1,startAt:0,scrollBar:i,activatePageOn:"click",speed:300,elasticBounds:1,dragHandle:1,clickBar:1}).init();$(window).on("resize",function(){e.reload()})});


$(function(){$(".video-slider").slick({arrows:!1,slidesToShow:1,dots:!0,dotsClass:"video__dots",draggable:!0,infinite:!1})});
$(function(){var i=document.createElement("script");i.src="https://www.youtube.com/iframe_api";var e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(i,e);var o={g:{n:void 0,id:"general-video",yid:"LP3xiE1qM-g"},h:{n:void 0,id:"how-video",yid:"ulYdQ0PTm64"},f:{n:void 0,id:"fashion-video",yid:"DGUgj9uOtNk"}};function u(i){i.target.stopVideo()}$(window).on("load",function(){var a=$(".video__dots button"),r=$(".js-modal-close"),s=$(".js-modal"),c=$(".cases__item");function i(e,i,o){var d,n;function t(i){i.click(function(){e.pauseVideo()})}d=i,n=o,e=new YT.Player(d,{videoId:n,playerVars:{autoplay:0,showinfo:0,rel:0},events:{onReady:u}}),t(a),t(r),t(s),t(c)}i(o.g.n,o.g.id,o.g.yid),i(o.h.n,o.h.id,o.h.yid),i(o.f.n,o.f.id,o.f.yid)})});
