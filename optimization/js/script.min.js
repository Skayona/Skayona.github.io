...
$.fn.clickToggle=function(i,n){var l=[n,i];return this.on("click",function(){l[this._tog^=1].call(this)})};var sm="(min-width: 768px)",md="(min-width: 992px)",lg="(min-width: 1200px)",container={sm:744,md:990,lg:1152},links=$('link[rel="preload"]');$(window).on("resize",function(){links.length&&links.each(function(i){var n,l=links[i].media;switch(links[i].as){case"style":n="stylesheet"}window.matchMedia(l).matches&&(links[i].rel=n)})});
...
$(function(){var s=$(".js-hamburger"),a="active",e=$(".js-header"),i=($(".js-nav"),$(".js-years"));s.click(function(){if(!$(this).hasClass(a))return $(this).addClass(a),e.addClass(a),void i.removeClass(a);s.removeClass(a),25<$(window).scrollTop()||e.removeClass(a)}),i.click(function(){if(!$(this).hasClass(a))return $(this).addClass(a),$(this).parent().addClass(a),void s.removeClass(a);$(this).removeClass(a),$(this).parent().removeClass(a)}),$(window).click(function(s){i.parent().has(s.target).length||(i.removeClass(a),i.parent().removeClass(a))}),$(window).on("load resize",function(){window.matchMedia(lg).matches&&s.removeClass(a)}),$(window).on("load resize scroll",function(){if(25<$(this).scrollTop())e.addClass(a);else{if(s.hasClass(a))return;e.removeClass(a)}})});
