...
$.fn.clickToggle=function(e,t){var n=[t,e];return this.on("click",function(){n[this._tog^=1].call(this)})},jQuery.event.special.mousewheel={setup:function(e,t,n){t.includes("noPreventDefault")?this.addEventListener("mousewheel",n,{passive:!1}):this.addEventListener("mousewheel",n,{passive:!0})}},jQuery.event.special.touchstart={setup:function(e,t,n){t.includes("noPreventDefault")?this.addEventListener("touchstart",n,{passive:!1}):this.addEventListener("touchstart",n,{passive:!0})}},jQuery.event.special.wheel={setup:function(e,t,n){t.includes("noPreventDefault")?this.addEventListener("wheel",n,{passive:!1}):this.addEventListener("wheel",n,{passive:!0})}};var sm="(min-width: 576px)",md="(min-width: 768px)",lg="(min-width: 992px)",xl="(min-width: 1200px)",xxl="(min-width: 1800px)",container={sm:550,md:744,lg:990,xl:1170,xxl:1620},body=$("body"),header=$("header"),footer=$("footer"),main=$("main"),fixedBody="body-fixed",bluredContent="content-blur";function inputError(e,n){e.on("focusout",function(){var e=$(this).val(),t=new RegExp($(this).attr("pattern"));0!=e&&t.test(e)?$(this).removeClass(n):$(this).addClass(n)})}var errorClass="error";
...
$(function(){var e=$(".b-slider"),r=$(".btn-slider-wrap"),i=$(".btn-slider.btn-slider--prev"),s=$(".btn-slider.btn-slider--next");$(".js-benefits .container"),$(".b-slider-wrap");e.slick({appendArrows:r,prevArrow:i,mobileFirst:!0,nextArrow:s,slidesToShow:1,responsive:[{breakpoint:767,settings:{slidesToShow:2}},{breakpoint:1199,settings:{variableWidth:!0}}]})});




$(function(){$(".js-year").text((new Date).getFullYear());var a=$("#subscribe-form"),t=$("#subscribe-email");inputError(t,errorClass),a.submit(function(r){if(r.preventDefault(),0==t.val()&&t.addClass(error),a.find($(".error")))console.log("error");else{var e=contactForm.serialize();$.ajax({type:"POST",url:"php/contact.php",dataType:"json",data:e,success:function(r){}})}})});
...
$(function(){var o=$(".js-modal"),e=$(".js-modal-content"),n=".js-modal-window",r="active",t=$(".js-modal-close"),a={login:{btn:$(".js-login-btn"),modal:$("#login")},order:{btn:$(".js-get-started"),modal:$("#order")},fashion:{btn:$(".js-fashion"),modal:$("#fashion")},perfumery:{btn:$(".js-perfumery"),modal:$("#perfumery")},outdoor:{btn:$(".js-outdoor"),modal:$("#outdoor")},electronics:{btn:$(".js-electronics"),modal:$("#electronics")},grocery:{btn:$(".js-grocery"),modal:$("#grocery")}},d=function(o){o.addClass(r),o.find(n).animate({top:0},300),body.addClass(fixedBody),header.addClass(bluredContent),footer.addClass(bluredContent),main.addClass(bluredContent)},l=function(){o.removeClass(r),o.find(n).animate({top:"-100vh"},300),$(".js-hamburger").hasClass(r)||body.removeClass(fixedBody),header.removeClass(bluredContent),footer.removeClass(bluredContent),main.removeClass(bluredContent)};function s(o,e){o.click(function(o){o.preventDefault(),d(e)})}e.click(function(o){o.stopPropagation()}),s(a.login.btn,a.login.modal),s(a.order.btn,a.order.modal),s(a.fashion.btn,a.fashion.modal),s(a.perfumery.btn,a.perfumery.modal),s(a.outdoor.btn,a.outdoor.modal),s(a.electronics.btn,a.electronics.modal),s(a.grocery.btn,a.grocery.modal),t.click(l),o.click(l)});
...
$(function(){var e=document.createElement("script");e.src="https://www.youtube.com/iframe_api";var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(e,i);var o={g:{n:void 0,id:"general-video",yid:"LP3xiE1qM-g"},h:{n:void 0,id:"how-video",yid:"ulYdQ0PTm64"},f:{n:void 0,id:"fashion-video",yid:"DGUgj9uOtNk"}};function s(e){e.target.stopVideo()}$(window).on("load",function(){var a=$(".video-item__img"),r=$(".video__dots button"),c=$(".js-modal-close"),l=$(".js-modal");function e(d,e,i){var o,t;function n(e){e.click(function(){d.pauseVideo()})}o=e,t=i,d=new YT.Player(o,{videoId:t,playerVars:{autoplay:0,showinfo:0,rel:0},events:{onReady:s}}),a.click(function(e){e.preventDefault(),d.pauseVideo();var i=$(this),o=i.parent().find($("iframe")).attr("id"),t=d.a.id;console.log("1");var n;n=function(){setTimeout(function(){i.fadeOut(100).removeAttr("style")},500)},o==t&&(d.playVideo(),n.call())}),n(r),n(c),n(l)}console.log("test"),e(o.g.n,o.g.id,o.g.yid),e(o.h.n,o.h.id,o.h.yid),e(o.f.n,o.f.id,o.f.yid)})});
