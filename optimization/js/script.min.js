...
$(function(){var o=$("#privacy-scroll .simplebar-scroll-content");function l(o){var l=o.scrollTop();l<o[0].scrollHeight-o.height()?$(".modal-content").addClass("scrolled-to-bottom"):$(".modal-content").removeClass("scrolled-to-bottom"),l?$(".modal-content").addClass("scrolled-from-top"):$(".modal-content").removeClass("scrolled-from-top")}$("#privacy-modal").click(function(){l(o)}),o.scroll(function(){l(o)})});
