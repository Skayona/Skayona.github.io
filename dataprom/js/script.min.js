...
$(function(){var e=$(".b-slider"),r=$(".btn-slider-wrap"),i=$(".btn-slider.btn-slider--prev"),s=$(".btn-slider.btn-slider--next");e.slick({appendArrows:r,prevArrow:i,mobileFirst:!0,nextArrow:s,slidesToShow:1,responsive:[{breakpoint:767,settings:{slidesToShow:2}},{breakpoint:1199,settings:{variableWidth:!0}}]})});


$(function(){var s=$("#contact-form"),t=$("#contact-email"),e=$("#contact-name"),n=s.attr("action");inputError(t,errorClass),inputError(e,errorClass),s.submit(function(r){if(r.preventDefault(),0==t.val()&&t.addClass(errorClass),0==e.val()&&e.addClass(errorClass),!s.find($(".form-input")).hasClass(errorClass)){var a=s.serialize();return $.ajax({type:"POST",url:n,dataType:"json",data:a,success:function(r){}}),s.trigger("reset"),!0}})});

$(function(){$(".js-year").text((new Date).getFullYear());var e=$("#subscribe-form"),s=$("#subscribe-email"),t=e.attr("action");inputError(s,errorClass),e.submit(function(r){if(r.preventDefault(),0==s.val()&&s.addClass(errorClass),!e.find($(".form-input")).hasClass(errorClass)){var a=e.serialize();return $.ajax({type:"POST",url:t,dataType:"json",data:a,success:function(r){}}),e.trigger("reset"),!0}})});
...
var overlay=$(".js-modal"),modalBtn=$(".js-modal-btn"),content=$(".js-modal-content"),mWindow=".js-modal-window",activeClass="active",modalCross=$(".js-modal-close"),modalActive=function(o){o.addClass(activeClass),o.find(mWindow).animate({top:0},300),body.addClass(fixedBody),header.addClass(bluredContent),footer.addClass(bluredContent),main.addClass(bluredContent)},modalClose=function(){overlay.removeClass(activeClass),overlay.find(mWindow).animate({top:"-100vh"},300),$(".js-hamburger").hasClass(activeClass)||body.removeClass(fixedBody),header.removeClass(bluredContent),footer.removeClass(bluredContent),main.removeClass(bluredContent)};function modalOpen(o,a){o.click(function(o){o.preventDefault();var a=$(this).attr("href"),e=$(body).find($(a));e.length&&modalActive(e)})}content.click(function(o){o.stopPropagation()}),modalOpen(modalBtn,overlay),modalCross.click(modalClose),overlay.click(modalClose);
...
$(function(){var e=$("#order-form"),s=$("#order-email"),o=$("#order-name"),r=$("#order-tel"),t=e.attr("action");inputError(s,errorClass),inputError(o,errorClass),inputError(r,errorClass),e.submit(function(r){if(r.preventDefault(),0==s.val()&&s.addClass(errorClass),0==o.val()&&o.addClass(errorClass),!e.find($(".form-input")).hasClass(errorClass)){var a=e.serialize();return $.ajax({type:"POST",url:t,dataType:"json",data:a,success:function(r){}}),e.trigger("reset"),setTimeout(function(){modalClose()},300),!0}})});
...
$(function(){var e=document.createElement("script");e.src="https://www.youtube.com/iframe_api";var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(e,i);var o={g:{n:void 0,id:"general-video",yid:"LP3xiE1qM-g"},h:{n:void 0,id:"how-video",yid:"ulYdQ0PTm64"},f:{n:void 0,id:"fashion-video",yid:"DGUgj9uOtNk"}};function s(e){e.target.stopVideo()}$(window).on("load",function(){var a=$(".video__dots button"),r=$(".cases__item");function e(i,e,o){var n,d;function t(e){e.click(function(){Object.keys(i.j).length&&i.pauseVideo()})}n=e,d=o,i=new YT.Player(n,{videoId:d,playerVars:{autoplay:0,showinfo:0,rel:0},events:{onReady:s}}),t(a),t(modalCross),t(overlay),t(r)}e(o.g.n,o.g.id,o.g.yid),e(o.h.n,o.h.id,o.h.yid),e(o.f.n,o.f.id,o.f.yid)})});
