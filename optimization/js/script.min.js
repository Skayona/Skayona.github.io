...
$(function(){var o=$("#cb-form"),c=$("#success-modal");o.submit(function(o){o.preventDefault(),console.log("+"),c.modal()})});
...
function modalConentFade(t){(t=$(t+" .simplebar-scroll-content")).scroll(function(){var o=t.scrollTop(),l=t[0].scrollHeight-t.height(),s=t.find(".modal-content");o<l?s.addClass("scrolled-to-bottom"):s.removeClass("scrolled-to-bottom"),o?s.addClass("scrolled-from-top"):s.removeClass("scrolled-from-top")})}
$(function(){modalConentFade("#edit-modal")});
$(function(){modalConentFade("#member-modal")});
$(function(){modalConentFade("#offer-modal")});
$(function(){modalConentFade("#pay-modal")});
$(function(){modalConentFade("#privacy-modal")});
$(function(){modalConentFade("#success-modal")});
...
$(function(){var e=$("#reg-form"),n=$("#success-modal");e.submit(function(e){e.preventDefault(),n.modal()})});
