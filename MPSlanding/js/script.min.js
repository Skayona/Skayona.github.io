...
function initMap(){var e={lat:45.466982,lng:9.186651},t={lat:52.518044,lng:13.406187},o={lat:49.453867,lng:11.081532},s={lat:41.875331,lng:-87.622133},r={lat:34.018558,lng:-118.486056},a={lat:50.448069,lng:30.52305};map=new google.maps.Map(document.getElementById("map"),{center:e,scrollwheel:!1,disableDefaultUI:!1,zoom:3,styles:[{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#3e3e3e"},{saturation:-100},{lightness:-20},{visibility:"on"}]},{elementType:"labels.text.stroke",stylers:[{color:"#efefef"},{lightness:30},{visibility:"on"},{weight:1}]},{featureType:"administrative",elementType:"geometry.fill",stylers:[{color:"#000000"},{lightness:20}]},{featureType:"administrative",elementType:"geometry.stroke",stylers:[{color:"#000000"},{lightness:17},{weight:1.2}]},{featureType:"landscape",elementType:"geometry",stylers:[{color:"#000000"},{lightness:20}]},{featureType:"landscape.natural",elementType:"geometry.fill",stylers:[{color:"#cccccc"}]},{featureType:"landscape.natural.landcover",elementType:"geometry.fill",stylers:[{color:"#cccccc"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#000000"},{lightness:21}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{color:"#000000"},{lightness:18}]},{featureType:"road.highway",elementType:"geometry.fill",stylers:[{color:"#000000"},{lightness:17}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{color:"#000000"},{lightness:29},{weight:.2}]},{featureType:"road.local",elementType:"geometry",stylers:[{color:"#000000"},{lightness:16}]},{featureType:"transit",elementType:"geometry",stylers:[{color:"#000000"},{lightness:19}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#000000"},{lightness:17}]},{featureType:"water",elementType:"geometry.fill",stylers:[{color:"#7b7b7b"}]},{featureType:"water",elementType:"labels.text",stylers:[{color:"#f4f5f9"}]}]});new google.maps.Marker({position:t,map:map,icon:"img/marker.png"}),new google.maps.Marker({position:e,map:map,icon:"img/marker.png"}),new google.maps.Marker({position:o,map:map,icon:"img/marker.png"}),new google.maps.Marker({position:s,map:map,icon:"img/marker.png"}),new google.maps.Marker({position:r,map:map,icon:"img/marker.png"}),new google.maps.Marker({position:a,map:map,icon:"img/marker.png"})}$(document).ready(function(){function e(){d.animate({d:"m 1.5,153.81 c 0,0 204.63779,34.36771 326.08,-46.32511 C 437.25088,34.613589 570,16.35 574.37,1.5"},5e3,mina.linear,t)}function t(){d.animate({d:"M1.5,153.81s184.05-83.34,326.08-50.37S570,16.35,574.37,1.5"},5e3,mina.linear,e)}function o(e){e.drawAtPath(d,15e3,{callback:o.bind(null,e)})}function s(){h=[];var e=0;v.forEach(function(t,a){var n=r(t),i=setTimeout(function(){function t(e){clearTimeout(e.timeoutId),h[e].element.clear(),h[e].element.remove()}var r=h.length;if(o(n),++e>6&&e<r)t(a=e-7);else if(e==r){var a=e-7;t(a);var i=1,l=setInterval(function(){i<7?(t(r+i-7),i++):(s(),clearInterval(l))},2500)}},2500*a);h.push({timeoutId:i,element:n})})}function r(e){var t=u.image(e,"0","0","25","25").attr({transform:"translate(-12.5, -12.5) rotate(180deg)"});t.node.removeAttribute("preserveAspectRatio");var o=u.g(y.clone().attr({opacity:1}),t).attr({transform:"scale(0)"});return o.animate({opacity:"1"},500,mina.linear),o}function a(){var e=$(".js-blog-item"),t=$(".js-blog-title"),o=$(".js-blog-desc"),s=$(".js-blog-link");e.each(function(e){var r=$(this).height()-$(t[e]).outerHeight()-$(s[e]).outerHeight()-106;$(o[e]).css({height:r})})}$(".js-btn-menu").on("click",function(){$("body").toggleClass("menu--show")});var n=$(".header"),i=$("body").hasClass("is-home"),l=$("body").hasClass("is-blog"),c=[];if($(".menu__link").each(function(e){c[e]=$(this).attr("href")}),i){$(window).on("load scroll",function(){$(this).scrollTop()>1?n.addClass("header--color"):n.removeClass("header--color")}),$(".header__logo-home ").removeAttr("href"),$(".js-scrollto").click(function(){var e=$(this).attr("href"),t=$(e).offset().top;return $("html:not(:animated),body:not(:animated)").animate({scrollTop:t},800),$("body").removeClass("menu--show"),!1});var m,p=$(".js-menu").outerHeight(),f=$(".js-scrollto"),g=f.map(function(){var e=$($(this).attr("href"));if(e.length)return e});f.click(function(e){var t=$(this).attr("href"),o="#"===t?0:$(t).offset().top-p+1;$("html, body").stop().animate({scrollTop:o},300),e.preventDefault()}),$(window).scroll(function(){var e=$(this).scrollTop()+p,t=g.map(function(){if($(this).offset().top<e)return this}),o=(t=t[t.length-1])&&t.length?t[0].id:"";m!==o&&(m=o,f.removeClass("menu__link--active").filter('[href="#'+o+'"]').addClass("menu__link--active"))}),Snap.plugin(function(e,t,o,s){t.prototype.drawAtPath=function(t,o,s){var r,a,n=this,i=this.getBBox(1),l={},c=t.getTotalLength(),m=0,p=c,f=0,g=mina.linear,u="";s&&(g=s.easing||g,s.reverse&&(m=c,p=0),s.drawpath&&(f=1,t.attr({fill:"none",strokeDasharray:c+" "+c,strokeDashoffset:this.len})),s.startingTransform&&(u=s.startingTransform),a=s.callback||function(){}),e.animate(m,p,function(e){r=t.getPointAtLength(e),l.x=r.x-i.cx,l.y=r.y-i.cy,n.transform(u+"t"+l.x+","+l.y+"r"+r.alpha),f&&t.attr({"stroke-dashoffset":c-e})},o,g,a)}});var u=Snap("#svgC"),d=u.path("M1.5,153.81s184.05-83.34,326.08-50.37S570,16.35,574.37,1.5").attr({fill:"none",strokeWidth:"1",stroke:"#4c8cf5"});e();var h,y=u.circle("0","0",20).attr({fill:"#fff",opacity:0,stroke:"#4c8cf5",strokeWidth:"1"}),v=[];$.getJSON("assets/technologiesLogo.json",function(e){for(key in e)v.push(e[key]);return v}),$(window).on("load",function(){s()}),$(window).blur(function(e){h.forEach(function(e){clearTimeout(e.timeoutId),e.element.clear(),e.element.remove()})}),$(window).focus(function(e){s()})}else n.addClass("header--color"),$(".menu__link").each(function(e){"#"==c[e][0]&&$(this).attr("href","index.html"+c[e])});l&&$(".menu__blog").addClass("menu__link--active"),$(window).on("load resize",function(){a()}),$(".js-partners-slider").slick({arrows:!1,mobileFirst:!0,autoplay:!0,autoplaySpeed:1500,rows:2,responsive:[{breakpoint:1199,settings:{slidesToShow:5}},{breakpoint:959,settings:{slidesToShow:4}},{breakpoint:659,settings:{slidesToShow:3}},{breakpoint:440,settings:{slidesToShow:2}}]}),$(".js-issues").slick({arrows:!1,dots:!0,autoplay:!0,autoplaySpeed:4e3,dotsClass:"issue__dots",infinite:!0,mobileFirst:!0,speed:0,fade:!0,cssEase:"linear"}),$(".js-team-main").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,fade:!0,asNavFor:".js-team-preview",lazyLoad:"ondemand"}),$(".js-team-preview").slick({mobileFirst:!0,slidesToShow:3,slidesToScroll:1,centerPadding:0,asNavFor:".js-team-main",centerMode:!0,focusOnSelect:!0,appendArrows:$(".team__arrows"),arrow:!0,prevArrow:$(".team__arrow--prev"),nextArrow:$(".team__arrow--next"),initialSlide:1,lazyLoad:"ondemand",responsive:[{breakpoint:660,settings:{slidesToShow:4}}]});var w=(new Date).getFullYear();$(".js-get-current-year").text(w);var T=$(".form__input");T.focusin(function(){$(this).addClass("form__input--focused"),$(this).prev(".form__input-title").addClass("form__input-title--focused")}),T.focusout(function(){0==$(this).val()&&($(this).removeClass("form__input--focused"),$(this).prev(".form__input-title").removeClass("form__input-title--focused"))}),$(".js-for-project").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,fade:!0,asNavFor:".js-nav-project",lazyLoad:"progressive"}),$(".js-nav-project").slick({arrows:!1,mobileFirst:!0,slidesToShow:1,slidesToScroll:1,asNavFor:".js-for-project",dots:!1,centerMode:!0,focusOnSelect:!0,lazyLoad:"progressive",customPaging:"10px",responsive:[{breakpoint:660,settings:{slidesToShow:3}},{breakpoint:992,settings:{slidesToShow:5,vertical:!0}}]})});var map;