...
$(function(){var s=$(".js-hamburger"),a="active",e="on-scroll",o=$(".js-header"),r=($(".js-nav"),$(".js-years")),t=$(".js-srcoll-top-year"),n=$(".js-srcoll-bottom-year");function l(s){var a=$(".js-prev-years"),e="not-active",o=-250,r=0,l=+a.css("transform").replace(/[matrix() ]/g,"").split(",")[5]+("top"==s?100:-100);l<o?(l=o,n.addClass(e)):r<l?(l=r,t.addClass(e)):(n.removeClass(e),t.removeClass(e)),a.css("transform","matrix(1, 0, 0, 1, 0,"+l+")")}function i(){25<$(this).scrollTop()?o.addClass(e):o.removeClass(e)}t.on("click",function(){l("top")}),n.on("click",function(){l("bottom")}),s.click(function(){if(!$(this).hasClass(a))return $(this).addClass(a),o.addClass(a),void r.removeClass(a);s.removeClass(a),o.removeClass(a)}),r.click(function(){if(!$(this).hasClass(a))return $(this).addClass(a),$(this).parent().addClass(a),void s.removeClass(a);$(this).removeClass(a),$(this).parent().removeClass(a)}),$(window).click(function(s){r.parent().has(s.target).length||(r.removeClass(a),r.parent().removeClass(a))}),$(window).on("load resize",function(){i(),window.matchMedia(lg).matches&&(s.removeClass(a),o.removeClass(a))}),$(window).on("load resize scroll",function(){r.removeClass(a),r.parent().removeClass(a),i()})});
