...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_webinar_activity_webinar_activity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(105);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ui_components_chat_chat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
/* harmony import */ var _node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(58);


{
  Object(_ui_components_chat_chat__WEBPACK_IMPORTED_MODULE_0__["default"])('#webinarChatInput');
}
{
  var container = document.querySelector('.js-web-video-slider');

  var stopPlayingVideos = function stopPlayingVideos() {
    var youtubeVideos = document.querySelectorAll('.js-youtube-video iframe');
  ...
  if (container) {
    var slider = Object(_node_modules_tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_1__["tns"])({
      container: container,
  ...
  var toggleScreens = document.querySelector('.js-toggle-screens');
  var frontScreen = document.querySelector('.js-front-screen');
  toggleScreens && toggleScreens.addEventListener('click', function () {
    stopPlayingVideos();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return initTextInpuResize; });
function initTextInpuResize(selector) {
  ...
  text.addEventListener('keydown', delayedResize, false); // text.focus();
  // text.select();
