...
$.fn.clickToggle=function(i,n){var e=[n,i];return this.on("click",function(){e[this._tog^=1].call(this)})};var sm="(min-width: 576px)",md="(min-width: 768px)",lg="(min-width: 992px)",xl="(min-width: 1200px)",xxl="(min-width: 1800px)",container={sm:550,md:744,lg:990,xl:1170,xxl:1620},links=$('link[rel="preload"]');$(window).on("resize",function(){links.length&&links.each(function(i){var n,e=links[i].media;switch(links[i].as){case"style":n="stylesheet"}window.matchMedia(e).matches&&(links[i].rel=n)})});var body=$("body"),header=$("header"),footer=$("footer"),main=$("main"),fixedBody="body-fixed",bluredContent="content-blur";function inputError(i,e){i.on("focusin",function(){$(this).removeClass(e)}).on("focusout",function(){var i=$(this).val(),n=new RegExp($(this).attr("pattern"));(!$(this).attr("required")||0!=i&&n.test(i))&&(0==i||n.test(i))?$(this).removeClass(e):$(this).addClass(e)})}var errorClass="error";AOS.init({duration:600,easing:"ease-in-sine",delay:1,disable:"mobile"}),AOS.refresh();
!function(){var e=$(".js-app-gallery");if(document.querySelector(".js-app-gallery")){e.slick({infinite:!0,centerMode:!0,centerPadding:"0",slidesToShow:5,slidesToScroll:5,arrows:!1,variableWidth:!0,autoplay:!0,autoplaySpeed:2e3,responsive:[{breakpoint:768,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]});var s=document.querySelectorAll(".js-app-gallery-img"),l=document.querySelector(".js-app-gallery-modal"),t=document.querySelector(".js-app-gallery-close"),i=document.querySelector(".js-app-gallery-modal-backdrop"),o=document.querySelector("body"),r=l.querySelector("img");s.forEach(function(s){s.addEventListener("click",function(){var e=s.getAttribute("data-img-src");r.setAttribute("src",e),l.classList.add("visible"),o.classList.add("body-fixed")})}),t.addEventListener("click",function(){l.classList.remove("visible"),o.classList.remove("body-fixed")}),i.addEventListener("click",function(){l.classList.remove("visible"),o.classList.remove("body-fixed")})}}();




$(function(){var e=$(".js-feat-2-carousel"),s=$(".js-feat-2-carousel-next");e.slick({infinite:!0,speed:300,slidesToShow:1,dots:!0,nextArrow:s,prevArrow:""})});

$(function(){var e,t,n,g,i,s=$(".js-year"),u=$(".js-current-time");s.text((new Date).getFullYear()),u.text((e=3,t=new Date,n=t.getTime()+6e4*t.getTimezoneOffset(),g=new Date(n+36e5*e),i=g.getMinutes()<10?"0"+g.getMinutes():g.getMinutes(),g.getHours()+":"+i))});
$(function(){var s=$("#contact-form"),t=$("#contact-email"),o=$("#contact-name"),r=$("#contact-tel"),e=s.attr("action");inputError(t,errorClass),inputError(o,errorClass),inputError(r,errorClass),r.focusout(function(){$(this).val()||$(this).removeClass(errorClass)}),s.submit(function(r){if(r.preventDefault(),t.val()||t.addClass(errorClass),o.val()||o.addClass(errorClass),!s.find($(".form-input")).hasClass(errorClass)){var a=s.serialize();return $.ajax({type:"POST",url:e,dataType:"json",data:a,success:function(r){console.log(r)}}),s.trigger("reset"),!0}})});
$(function(){var e=$(".js-hamburger"),o=$(".js-menu-item"),a=$(".js-header"),t="active",s="on-scroll";function i(o){o.toggleClass(t),body.toggleClass(fixedBody)}e.clickToggle(function(){i($(this))},function(){i($(this))}),$(window).on("load scroll",function(){25<$(this).scrollTop()?a.addClass(s):a.removeClass(s)}),$(window).on("resize",function(){window.matchMedia(lg).matches&&body.hasClass(fixedBody)&&e.hasClass(t)&&($(".js-modal").hasClass(t)||body.removeClass(fixedBody),e.removeClass(t))}),o.click(function(){var o,s=$(this).attr("href");return o="#home"==s?0:$(s).offset().top-a.height(),$("html:not(:animated),body:not(:animated)").animate({scrollTop:o},800),window.matchMedia(lg).matches||(body.removeClass(fixedBody),e.removeClass(t)),!1}),$(window).on("load resize",function(){a.height(),o.map(function(){var o=$($(this).attr("href"));if(o.length)return o});25<$(this).scrollTop()&&a.addClass(s)})});


$(function(){var e=$(".js-review-slider"),s=$(".js-review-dots");e.slick({arrows:!1,dots:!0,appendDots:s,autoplay:!0,autoplaySpeed:5e3})});



!function(){if(document.querySelector("#pinContainer")&&window.matchMedia(lg).matches){var e=new ScrollMagic.Controller,n=(new TimelineMax).fromTo(".steps-to-hire__item-bg",1,{y:"0%"},{y:"300%",ease:Linear.easeNone});new ScrollMagic.Scene({triggerElement:"#pinContainer",triggerHook:"onLeave",duration:"100%",offset:-64}).setPin("#pinContainer").setTween(n).addTo(e)}}();
$(function(){var e=$(".js-team-gallery"),a=$(".js-team-next"),t=$(".js-team-prev");e.slick({infinite:!0,speed:300,slidesToShow:1,centerMode:!0,variableWidth:!0,nextArrow:a,prevArrow:t,autoplay:!0,autoplaySpeed:3e3})});
$(function(){var e=$(".js-team-2-carousel");if(e.length){var t=$(".js-team-2-carousel-next"),r=$(".js-team-2-carousel-prev"),n=$(".js-total")[0],i=$(".js-current")[0],a=$(".js-member").length;n.innerText=a,e.slick({infinite:!0,centerMode:!0,speed:0,slidesToShow:3,nextArrow:t,prevArrow:r,variableWidth:!0,waitForAnimate:!1,responsive:[{breakpoint:768,settings:{adaptiveHeight:!0,centerMode:!1,variableWidth:!1,slidesToShow:1}}]}),e.on("afterChange",function(e,t,r,n){i.innerText=r+1})}});



$(function(){var o={phone:"439918",img1:"http://onelogicsoft.com/img/zadarma/call.png",img2:"http://onelogicsoft.com/img/zadarma/connecting.png",img3:"http://onelogicsoft.com/img/zadarma/end.png",img4:"http://onelogicsoft.com/img/zadarma/error.png"},a={wmode:"transparent"};swfobject.embedSWF("https://zadarma.com/pbutton.swf","zadarma","180","50","9.0.0",!1,o,a,{})});



$(function(){var o=$(".js-product-for"),s=$(".js-product-nav");o.slick({slidesToShow:1,slidesToScroll:1,arrows:!1,fade:!0,asNavFor:s}),s.slick({slidesToShow:1,slidesToScroll:1,asNavFor:o,centerMode:!0,focusOnSelect:!0,arrows:!1,mobileFirst:!0,variableWidth:!0})});
