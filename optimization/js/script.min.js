...
$.fn.clickToggle=function(n,i){var e=[i,n];return this.on("click",function(){e[this._tog^=1].call(this)})};var sm="(min-width: 768px)",md="(min-width: 992px)",lg="(min-width: 1200px)",container={sm:744,md:990,lg:1152},links=$('link[rel="preload"]');$(window).on("resize",function(){links.length&&links.each(function(n){var i,e=links[n].media;switch(links[n].as){case"style":i="stylesheet"}window.matchMedia(e).matches&&(links[n].rel=i)})}),$(window).on("load",function(){new ScrollTrigger({once:!0,offset:{x:0,y:100}}),new Rellax(".js-rellax",{center:!0})});
