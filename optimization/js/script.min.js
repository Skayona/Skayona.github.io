...
var map;function initMap(){var a={lat:55.740542,lng:37.609599};map=new google.maps.Map(document.getElementById("conf-map"),{center:a,scrollwheel:!1,disableDefaultUI:!0,zoom:18,styles:[{stylers:[{saturation:-100}]}]});new google.maps.Marker({position:a,map:map,icon:"img/marker.png"})}
