...
$.fn.clickToggle=function(i,t){var n=[t,i];return this.on("click",function(){n[this._tog^=1].call(this)})};var sm="(min-width: 576px)",md="(min-width: 768px)",lg="(min-width: 992px)",xl="(min-width: 1200px)",xxl="(min-width: 1800px)",container={sm:550,md:744,lg:990,xl:1170,xxl:1620},body=$("body"),header=$("header"),footer=$("footer"),main=$("main"),fixedBody="body-fixed",bluredContent="content-blur";function inputError(i,n){i.on("focusin",function(){$(this).removeClass(n)}).on("focusout",function(){var i=$(this).val(),t=new RegExp($(this).attr("pattern"));(!$(this).attr("required")||0!=i&&t.test(i))&&(0==i||t.test(i))?$(this).removeClass(n):$(this).addClass(n)})}var errorClass="error";AOS.init({duration:600,easing:"ease-in-sine",delay:1,disable:"mobile"}),AOS.refresh();
