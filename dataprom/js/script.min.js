...
$(function(){var e=document.createElement("script");e.src="https://www.youtube.com/iframe_api";var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(e,i);var o={g:{n:void 0,id:"general-video",yid:"LP3xiE1qM-g"},h:{n:void 0,id:"how-video",yid:"ulYdQ0PTm64"},f:{n:void 0,id:"fashion-video",yid:"DGUgj9uOtNk"}};function u(e){e.target.stopVideo()}$(window).on("load",function(){var a=$(".video__dots button"),r=$(".js-modal-close"),s=$(".js-modal"),c=$(".cases__item");function e(i,e,o){var n,d;function t(e){e.click(function(){Object.keys(i.j).length&&i.pauseVideo()})}n=e,d=o,i=new YT.Player(n,{videoId:d,playerVars:{autoplay:0,showinfo:0,rel:0},events:{onReady:u}}),t(a),t(r),t(s),t(c)}e(o.g.n,o.g.id,o.g.yid),e(o.h.n,o.h.id,o.h.yid),e(o.f.n,o.f.id,o.f.yid)})});
