...
$(function(){$("#cb-form").submit(function(n){n.preventDefault(),console.log("+")})});
...
$(function(){$(function(){var t=$(".modal .simplebar-scroll-content");t.scroll(function(){var o,l;(l=(o=t).scrollTop())<o[0].scrollHeight-o.height()?$(".modal-content").addClass("scrolled-to-bottom"):$(".modal-content").removeClass("scrolled-to-bottom"),l?$(".modal-content").addClass("scrolled-from-top"):$(".modal-content").removeClass("scrolled-from-top")})})});
