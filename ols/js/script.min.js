...
$(function(){if(window.matchMedia(lg).matches){var e=new ScrollMagic.Controller,n=(new TimelineMax).fromTo(".steps-to-hire__item-bg",1,{y:"0%"},{y:"300%",ease:Linear.easeNone});new ScrollMagic.Scene({triggerElement:"#pinContainer",triggerHook:"onLeave",duration:"100%",offset:-64}).setPin("#pinContainer").setTween(n).addTo(e)}});
