...
$(function(){var o=$(".js-modal"),e=$(".js-modal-content"),n=".js-modal-window",t="active",r=$(".js-modal-close"),l={login:{btn:$(".js-login-btn"),modal:$("#login")},order:{btn:$(".js-get-started"),modal:$("#order")},fashion:{btn:$(".js-fashion"),modal:$("#fashion")},perfumery:{btn:$(".js-perfumery"),modal:$("#perfumery")},outdoor:{btn:$(".js-outdoor"),modal:$("#outdoor")},electronics:{btn:$(".js-electronics"),modal:$("#electronics")},grocery:{btn:$(".js-grocery"),modal:$("#grocery")},client:{btn:$(".js-client"),modal:$("#client")}},a=function(o){o.addClass(t),o.find(n).animate({top:0},300),body.addClass(fixedBody),header.addClass(bluredContent),footer.addClass(bluredContent),main.addClass(bluredContent)},d=function(){o.removeClass(t),o.find(n).animate({top:"-100vh"},300),$(".js-hamburger").hasClass(t)||body.removeClass(fixedBody),header.removeClass(bluredContent),footer.removeClass(bluredContent),main.removeClass(bluredContent)};function s(o,e){o.click(function(o){o.preventDefault(),a(e)})}e.click(function(o){o.stopPropagation()}),s(l.login.btn,l.login.modal),s(l.order.btn,l.order.modal),s(l.fashion.btn,l.fashion.modal),s(l.perfumery.btn,l.perfumery.modal),s(l.outdoor.btn,l.outdoor.modal),s(l.electronics.btn,l.electronics.modal),s(l.grocery.btn,l.grocery.modal),s(l.client.btn,l.client.modal),r.click(d),o.click(d)});
...
$(function(){var o,e={g:$("#general-video")[0],h:$("#how-video")[0],f:$("#fashion-video")[0]},n=$(".video__dots button");$(".js-modal-close"),$(".js-modal");o=e.g,n.click(function(){iframe=o.contentWindow,iframe.postMessage('{ "event" : "command", "func" : "pauseVideo" , "args":""}',"*")})});
