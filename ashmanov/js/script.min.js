...
$.fn.clickToggle=function(c,i){var n=[i,c];return this.on("click",function(){n[this._tog^=1].call(this)})};
$(function(){$.fn.clickToggle=function(t,o){var c=[o,t];return this.on("click",function(){c[this._tog^=1].call(this)})};var t=$(".js-toggle-footer"),o=$(".js-n-footer-top");function c(){t.toggleClass("active"),o.toggleClass("active")}t.clickToggle(c,c)});
function modalContentFade(o){(o=$(o+" .simplebar-scroll-content")).scroll(function(){var e=o.scrollTop(),t=o[0].scrollHeight-o.height(),l=o.find(".modal-content");e<t?l.addClass("scrolled-to-bottom"):l.removeClass("scrolled-to-bottom"),e?l.addClass("scrolled-from-top"):l.removeClass("scrolled-from-top")})}$(function(){modalContentFade("#agreement-modal");var t="#callback-modal",l=$("#success-modal"),e=$("#form-callback");modalContentFade(t),$("#time-start-styler").styler(),$("#time-end-styler").styler();var o=$("#phone-callback");new Inputmask("+7 (999) 999-99-99").mask(o),e.submit(function(e){e.preventDefault(),l.modal(),$(t).modal("hide")});var a="#request-modal",n=(l=$("#success-modal"),$("#form-request")),s=$("#file-request"),m=$(".jq-file__remove");modalContentFade(a),$("#theme-request-styler").styler(),s.change(function(e){e.target.files.length?(console.log($(this)),$(this).parent().find(".jq-file__name").text(e.target.files[0].name),m.fadeIn()):($(this).parent().find(".jq-file__name").text("Прикрепить файл"),m.css("display","none"))}),m.click(function(){s.val(""),s.parent().find(".jq-file__name").text("Прикрепить файл"),m.css("display","none")});o=$("#phone-request");new Inputmask("+7 (999) 999-99-99").mask(o),n.submit(function(e){e.preventDefault(),l.modal(),$(a).modal("hide")}),modalContentFade("#success-modal")});
$(function(){$.fn.clickToggle=function(n,i){var e=[i,n];return this.on("click",function(){e[this._tog^=1].call(this)})};var n=function(n){var s=n,i=$("html").hasClass("bx-touch"),t={link:null,time:null},u=null,b=null;function a(n){var i=$(".b-submenu-container--is-open").find(".b-submenu"),e=$(".b-sub-submenu-container__item--is-open").find(".b-sub-submenu"),s=parseInt(i.outerHeight());e.css("height",s);var t=n.find(".b-sub-submenu__block"),u=32,b=40+$(t[0]).parent().outerWidth(),a=n.find(".b-sub-submenu").outerWidth();t.each(function(n){u+=$(this).parent().outerHeight(),s<=u&&(u=32+$(this).parent().outerHeight(),b+=$(this).parent().outerWidth())}),b=b<a?a:b,n.find(".b-sub-submenu").css("width",b)}function l(){$(".b-menu__link.b-link--is-active").removeClass("b-link--is-active"),$(".b-submenu-container--is-open").removeClass("b-submenu-container--is-open")}i?(s.find(".b-menu__link").click(function(){l();var n=$(this),i=n.attr("href"),e=n.siblings(".b-submenu-container"),s=0<e.length;if(n.hasClass("b-link--is-active")||n.addClass("b-link--is-active"),e.css("left",parseInt($(this).offset().left)-32),s&&(e.addClass("b-submenu-container--is-open"),u!=i))return u=i,!1}),s.find(".b-submenu__link").click(function(){$(".b-sub-submenu-container__item--is-open").removeClass("b-sub-submenu-container__item--is-open");var n=$(this),i=n.attr("href"),e=s.find('.b-sub-submenu-container__item[data-href="'+i+'"]');if(s.find(".b-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active"),n.hasClass("b-submenu__link--has-submenu")&&0<e.length&&(e.addClass("b-sub-submenu-container__item--is-open"),a(),b!=i))return b=i,!1}),s.find(".b-sub-submenu__link").click(function(){var n=$(this);s.find(".b-sub-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active")}),$("body, .b-city__link, .b-search__link").on("click",function(){l()})):(s.find(".b-menu__link").hover(function(){l();var n=$(this),i=n.siblings(".b-submenu-container"),e=0<i.length;n.hasClass("b-link--is-active")||n.addClass("b-link--is-active"),i.css("left",parseInt($(this).offset().left)-32),e&&(i.addClass("b-submenu-container--is-open"),t={link:$(this).attr("href"),time:(new Date).getTime()})}),s.find(".b-menu__link").on("click",function(){if((new Date).getTime()-t.time<700&&t.link==$(this).attr("href"))return!1}),s.find(".b-submenu__link").hover(function(){$(".b-sub-submenu-container__item--is-open").removeClass("b-sub-submenu-container__item--is-open");var n=$(this),i=n.attr("href"),e=s.find('.b-sub-submenu-container__item[data-href="'+i+'"]');s.find(".b-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active"),n.hasClass("b-submenu__link--has-submenu")&&0<e.length&&(e.addClass("b-sub-submenu-container__item--is-open"),a(e))}),s.find(".b-sub-submenu__link").hover(function(){var n=$(this);s.find(".b-sub-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active")}),$("body, .b-city__link, .b-search__link").on("click",function(){l()}),s.find(".b-submenu-container").hover(function(){},function(){var n=$(this),i="b-submenu-container--is-open";n.hasClass(i)&&n.removeClass(i)}))};new n($(".b-desktop-menu")),new n($(".b-connect-us"));var i=$(".b-menu2");$(".b-menu-icon").click(function(){i.hasClass("b-menu2--is-open")?($("body").addClass("mobile-menu-is-open"),$(".menu-mobile-open-overlay").fadeIn()):($("body").removeClass("mobile-menu-is-open"),$(".menu-mobile-open-overlay").fadeOut())}),$(window).on("resize",function(){window.matchMedia("(min-width: 1200px)").matches&&(i.removeClass("b-menu2--is-open"),i.fadeOut().css("left","0"),$("body").removeClass("mobile-menu-is-open"),$(".menu-mobile-open-overlay").fadeOut())})});
...
$(function(){$(".js-ratings").each(function(){var t=$(this).find(".js-rating-percent"),n=$(this).find(".js-rating-bar"),i=t.data("percents");t.text(i),n.css("width",i+"%")})});

$(function(){$.fn.clickToggle=function(i,t){var n=[t,i];return this.on("click",function(){n[this._tog^=1].call(this)})},$(".js-services-list").each(function(){var i=$(this).find(".n-service-list__item"),t=$(this).find(".js-toggle-service");function n(){t.toggleClass("hidden"),i.toggleClass("hidden")}t.clickToggle(n,n),6<i.length&&t.addClass("active")})});