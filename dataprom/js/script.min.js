...
$(function(){var i=document.createElement("script");i.src="https://www.youtube.com/iframe_api";var e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(i,e);var o={g:{n:void 0,id:"general-video",yid:"LP3xiE1qM-g"},h:{n:void 0,id:"how-video",yid:"ulYdQ0PTm64"},f:{n:void 0,id:"fashion-video",yid:"DGUgj9uOtNk"}};function f(i){i.target.stopVideo()}function t(n,i,e){var o,t;o=i,t=e,n=new YT.Player(o,{videoId:t,playerVars:{autoplay:0,showinfo:0,rel:0},events:{onReady:f}});var d=$(".video-item__img"),a=$(".video__dots button"),r=$(".js-modal-close"),c=$(".js-modal");function u(i){i.click(function(){n.pauseVideo()})}d.click(function(){var i=$(this),e=i.parent().find($("iframe")).attr("id"),o=n.a.id;n.pauseVideo();var t;t=function(){setTimeout(function(){i.fadeOut(100).removeAttr("style")},500)},e==o&&(n.playVideo(),t.call())}),u(a),u(r),u(c)}$(window).on("load",function(){t(o.g.n,o.g.id,o.g.yid),t(o.h.n,o.h.id,o.h.yid),t(o.f.n,o.f.id,o.f.yid)})});
