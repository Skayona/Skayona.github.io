...
$(function(){var e,t=$(".js-year"),n=$(".js-current-time");t.text((new Date).getFullYear()),n.text((e=3,d=new Date,utc=d.getTime()+6e4*d.getTimezoneOffset(),nd=new Date(utc+36e5*e),nd.getHours()+":"+nd.getMinutes()))});
