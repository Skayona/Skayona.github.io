...
$(function(){var n=function(n){var e=n,i=$("html").hasClass("bx-touch"),t={link:null,time:null},u=null,b=null;function a(n){var i=$(".b-submenu-container--is-open").find(".b-submenu"),s=$(".b-sub-submenu-container__item--is-open").find(".b-sub-submenu"),e=parseInt(i.outerHeight());s.css("height",e);var t=n.find(".b-sub-submenu__block"),u=42,b=40+$(t[0]).parent().outerWidth(),a=n.find(".b-sub-submenu").outerWidth();t.each(function(n){u+=$(this).parent().outerHeight(),e<=u&&(u=42+$(this).parent().outerHeight(),b+=$(this).parent().outerWidth())}),b=b<a?a:b,n.find(".b-sub-submenu").css("width",b)}function l(){$(".b-menu__link.b-link--is-active").removeClass("b-link--is-active"),$(".b-submenu-container--is-open").removeClass("b-submenu-container--is-open")}i?(e.find(".b-menu__link").click(function(){l();var n=$(this),i=n.attr("href"),s=n.siblings(".b-submenu-container"),e=0<s.length;if(n.hasClass("b-link--is-active")||n.addClass("b-link--is-active"),s.css("left",parseInt($(this).offset().left)-32),e&&(s.addClass("b-submenu-container--is-open"),u!=i))return u=i,!1}),e.find(".b-submenu__link").click(function(){$(".b-sub-submenu-container__item--is-open").removeClass("b-sub-submenu-container__item--is-open");var n=$(this),i=n.attr("href"),s=e.find('.b-sub-submenu-container__item[data-href="'+i+'"]');if(e.find(".b-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active"),n.hasClass("b-submenu__link--has-submenu")&&0<s.length&&(s.addClass("b-sub-submenu-container__item--is-open"),a(),b!=i))return b=i,!1}),e.find(".b-sub-submenu__link").click(function(){var n=$(this);e.find(".b-sub-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active")}),$("body, .b-city__link, .b-search__link").on("click",function(){l()})):(e.find(".b-menu__link").hover(function(){l();var n=$(this),i=n.siblings(".b-submenu-container"),s=0<i.length;n.hasClass("b-link--is-active")||n.addClass("b-link--is-active"),i.css("left",parseInt($(this).offset().left)-32),s&&(i.addClass("b-submenu-container--is-open"),t={link:$(this).attr("href"),time:(new Date).getTime()})}),e.find(".b-menu__link").on("click",function(){if((new Date).getTime()-t.time<700&&t.link==$(this).attr("href"))return!1}),e.find(".b-submenu__link").hover(function(){$(".b-sub-submenu-container__item--is-open").removeClass("b-sub-submenu-container__item--is-open");var n=$(this),i=n.attr("href"),s=e.find('.b-sub-submenu-container__item[data-href="'+i+'"]');e.find(".b-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active"),n.hasClass("b-submenu__link--has-submenu")&&0<s.length&&(s.addClass("b-sub-submenu-container__item--is-open"),a(s))}),e.find(".b-sub-submenu__link").hover(function(){var n=$(this);e.find(".b-sub-submenu__link.b-link--is-active").removeClass("b-link--is-active"),n.addClass("b-link--is-active")}),$("body, .b-city__link, .b-search__link").on("click",function(){l()}),e.find(".b-submenu-container").hover(function(){},function(){var n=$(this),i="b-submenu-container--is-open";n.hasClass(i)&&n.removeClass(i)}))};new n($(".b-desktop-menu")),new n($(".b-connect-us"))});
...
$(function(){var t="#request-modal",n=$("#success-modal"),e=$("#form-request");modalContentFade(t),$("#theme-request-styler").styler(),$("#file-request").change(function(e){$(this).parent().find(".jq-file__name").text(e.target.files.length?e.target.files[0].name:"Прикрепить файл")});var a=$("#phone-request");new Inputmask("+7 (999) 999-99-99").mask(a),e.submit(function(e){e.preventDefault(),n.modal(),$(t).modal("hide")})});
